...
exports.WhileLoopActionUsageRequestToJSON = exports.WhileLoopActionUsageRequestFromJSONTyped = exports.WhileLoopActionUsageRequestFromJSON = exports.instanceOfWhileLoopActionUsageRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the WhileLoopActionUsageRequest interface.
 */
function instanceOfWhileLoopActionUsageRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfWhileLoopActionUsageRequest = instanceOfWhileLoopActionUsageRequest;
function WhileLoopActionUsageRequestFromJSON(json) {
    return WhileLoopActionUsageRequestFromJSONTyped(json, false);
}
exports.WhileLoopActionUsageRequestFromJSON = WhileLoopActionUsageRequestFromJSON;
function WhileLoopActionUsageRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'untilArgument': !(0, runtime_1.exists)(json, 'untilArgument') ? undefined : json['untilArgument'],
        ...
        'whileArgument': !(0, runtime_1.exists)(json, 'whileArgument') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['whileArgument']),
    };
}
exports.WhileLoopActionUsageRequestFromJSONTyped = WhileLoopActionUsageRequestFromJSONTyped;
function WhileLoopActionUsageRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'whileArgument': (0, Identified_1.IdentifiedToJSON)(value.whileArgument),
    };
}
exports.WhileLoopActionUsageRequestToJSON = WhileLoopActionUsageRequestToJSON;
