...
exports.MembershipExposeToJSON = exports.MembershipExposeFromJSONTyped = exports.MembershipExposeFromJSON = exports.instanceOfMembershipExpose = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the MembershipExpose interface.
 */
function instanceOfMembershipExpose(value) {
    let isInstance = true;
...
exports.instanceOfMembershipExpose = instanceOfMembershipExpose;
function MembershipExposeFromJSON(json) {
    return MembershipExposeFromJSONTyped(json, false);
}
exports.MembershipExposeFromJSON = MembershipExposeFromJSON;
function MembershipExposeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'importedMembership': (0, Identified_1.IdentifiedFromJSON)(json['importedMembership']),
...
exports.MembershipExposeFromJSONTyped = MembershipExposeFromJSONTyped;
function MembershipExposeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.MembershipExposeToJSON = MembershipExposeToJSON;
