...
exports.SelectExpressionToJSON = exports.SelectExpressionFromJSONTyped = exports.SelectExpressionFromJSON = exports.instanceOfSelectExpression = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the SelectExpression interface.
 */
function instanceOfSelectExpression(value) {
    let isInstance = true;
...
exports.instanceOfSelectExpression = instanceOfSelectExpression;
function SelectExpressionFromJSON(json) {
    return SelectExpressionFromJSONTyped(json, false);
}
exports.SelectExpressionFromJSON = SelectExpressionFromJSON;
function SelectExpressionFromJSONTyped(json, ignoreDiscriminator) {
...
exports.SelectExpressionFromJSONTyped = SelectExpressionFromJSONTyped;
function SelectExpressionToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.SelectExpressionToJSON = SelectExpressionToJSON;
