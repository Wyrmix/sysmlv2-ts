...
exports.ConjugatedPortDefinitionToJSON = exports.ConjugatedPortDefinitionFromJSONTyped = exports.ConjugatedPortDefinitionFromJSON = exports.instanceOfConjugatedPortDefinition = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the ConjugatedPortDefinition interface.
 */
function instanceOfConjugatedPortDefinition(value) {
    let isInstance = true;
...
exports.instanceOfConjugatedPortDefinition = instanceOfConjugatedPortDefinition;
function ConjugatedPortDefinitionFromJSON(json) {
    return ConjugatedPortDefinitionFromJSONTyped(json, false);
}
exports.ConjugatedPortDefinitionFromJSON = ConjugatedPortDefinitionFromJSON;
function ConjugatedPortDefinitionFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'ownedPortConjugator': (0, Identified_1.IdentifiedFromJSON)(json['ownedPortConjugator']),
...
exports.ConjugatedPortDefinitionFromJSONTyped = ConjugatedPortDefinitionFromJSONTyped;
function ConjugatedPortDefinitionToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ConjugatedPortDefinitionToJSON = ConjugatedPortDefinitionToJSON;
