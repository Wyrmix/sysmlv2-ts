...
exports.ViewpointUsageToJSON = exports.ViewpointUsageFromJSONTyped = exports.ViewpointUsageFromJSON = exports.instanceOfViewpointUsage = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the ViewpointUsage interface.
 */
function instanceOfViewpointUsage(value) {
    let isInstance = true;
...
exports.instanceOfViewpointUsage = instanceOfViewpointUsage;
function ViewpointUsageFromJSON(json) {
    return ViewpointUsageFromJSONTyped(json, false);
}
exports.ViewpointUsageFromJSON = ViewpointUsageFromJSON;
function ViewpointUsageFromJSONTyped(json, ignoreDiscriminator) {
...
exports.ViewpointUsageFromJSONTyped = ViewpointUsageFromJSONTyped;
function ViewpointUsageToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ViewpointUsageToJSON = ViewpointUsageToJSON;
