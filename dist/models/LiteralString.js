...
exports.LiteralStringToJSON = exports.LiteralStringFromJSONTyped = exports.LiteralStringFromJSON = exports.instanceOfLiteralString = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the LiteralString interface.
 */
function instanceOfLiteralString(value) {
    let isInstance = true;
...
exports.instanceOfLiteralString = instanceOfLiteralString;
function LiteralStringFromJSON(json) {
    return LiteralStringFromJSONTyped(json, false);
}
exports.LiteralStringFromJSON = LiteralStringFromJSON;
function LiteralStringFromJSONTyped(json, ignoreDiscriminator) {
...
exports.LiteralStringFromJSONTyped = LiteralStringFromJSONTyped;
function LiteralStringToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.LiteralStringToJSON = LiteralStringToJSON;
