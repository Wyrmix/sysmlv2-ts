...
exports.PortioningFeatureToJSON = exports.PortioningFeatureFromJSONTyped = exports.PortioningFeatureFromJSON = exports.instanceOfPortioningFeature = void 0;
/**
 * Check if a given object implements the PortioningFeature interface.
 */
function instanceOfPortioningFeature(value) {
    let isInstance = true;
...
exports.instanceOfPortioningFeature = instanceOfPortioningFeature;
function PortioningFeatureFromJSON(json) {
    return PortioningFeatureFromJSONTyped(json, false);
}
exports.PortioningFeatureFromJSON = PortioningFeatureFromJSON;
function PortioningFeatureFromJSONTyped(json, ignoreDiscriminator) {
...
exports.PortioningFeatureFromJSONTyped = PortioningFeatureFromJSONTyped;
function PortioningFeatureToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.PortioningFeatureToJSON = PortioningFeatureToJSON;
