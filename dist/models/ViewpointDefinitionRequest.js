...
exports.ViewpointDefinitionRequestToJSON = exports.ViewpointDefinitionRequestFromJSONTyped = exports.ViewpointDefinitionRequestFromJSON = exports.instanceOfViewpointDefinitionRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the ViewpointDefinitionRequest interface.
 */
function instanceOfViewpointDefinitionRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfViewpointDefinitionRequest = instanceOfViewpointDefinitionRequest;
function ViewpointDefinitionRequestFromJSON(json) {
    return ViewpointDefinitionRequestFromJSONTyped(json, false);
}
exports.ViewpointDefinitionRequestFromJSON = ViewpointDefinitionRequestFromJSON;
function ViewpointDefinitionRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.ViewpointDefinitionRequestFromJSONTyped = ViewpointDefinitionRequestFromJSONTyped;
function ViewpointDefinitionRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ViewpointDefinitionRequestToJSON = ViewpointDefinitionRequestToJSON;
