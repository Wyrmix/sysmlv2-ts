...
exports.ItemFlowEndRequestToJSON = exports.ItemFlowEndRequestFromJSONTyped = exports.ItemFlowEndRequestFromJSON = exports.instanceOfItemFlowEndRequest = void 0;
const runtime_1 = require("../runtime");
/**
 * Check if a given object implements the ItemFlowEndRequest interface.
 */
function instanceOfItemFlowEndRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfItemFlowEndRequest = instanceOfItemFlowEndRequest;
function ItemFlowEndRequestFromJSON(json) {
    return ItemFlowEndRequestFromJSONTyped(json, false);
}
exports.ItemFlowEndRequestFromJSON = ItemFlowEndRequestFromJSON;
function ItemFlowEndRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.ItemFlowEndRequestFromJSONTyped = ItemFlowEndRequestFromJSONTyped;
function ItemFlowEndRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ItemFlowEndRequestToJSON = ItemFlowEndRequestToJSON;
