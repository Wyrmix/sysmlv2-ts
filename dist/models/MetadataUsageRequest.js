...
exports.MetadataUsageRequestToJSON = exports.MetadataUsageRequestFromJSONTyped = exports.MetadataUsageRequestFromJSON = exports.instanceOfMetadataUsageRequest = void 0;
const runtime_1 = require("../runtime");
/**
 * Check if a given object implements the MetadataUsageRequest interface.
 */
function instanceOfMetadataUsageRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfMetadataUsageRequest = instanceOfMetadataUsageRequest;
function MetadataUsageRequestFromJSON(json) {
    return MetadataUsageRequestFromJSONTyped(json, false);
}
exports.MetadataUsageRequestFromJSON = MetadataUsageRequestFromJSON;
function MetadataUsageRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'metaclass': !(0, runtime_1.exists)(json, 'metaclass') ? undefined : json['metaclass'],
        'metadataDefinition': !(0, runtime_1.exists)(json, 'metadataDefinition') ? undefined : json['metadataDefinition'],
...
exports.MetadataUsageRequestFromJSONTyped = MetadataUsageRequestFromJSONTyped;
function MetadataUsageRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.MetadataUsageRequestToJSON = MetadataUsageRequestToJSON;
