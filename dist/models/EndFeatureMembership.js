...
exports.EndFeatureMembershipToJSON = exports.EndFeatureMembershipFromJSONTyped = exports.EndFeatureMembershipFromJSON = exports.instanceOfEndFeatureMembership = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the EndFeatureMembership interface.
 */
function instanceOfEndFeatureMembership(value) {
    let isInstance = true;
...
exports.instanceOfEndFeatureMembership = instanceOfEndFeatureMembership;
function EndFeatureMembershipFromJSON(json) {
    return EndFeatureMembershipFromJSONTyped(json, false);
}
exports.EndFeatureMembershipFromJSON = EndFeatureMembershipFromJSON;
function EndFeatureMembershipFromJSONTyped(json, ignoreDiscriminator) {
...
exports.EndFeatureMembershipFromJSONTyped = EndFeatureMembershipFromJSONTyped;
function EndFeatureMembershipToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.EndFeatureMembershipToJSON = EndFeatureMembershipToJSON;
