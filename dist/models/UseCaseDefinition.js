...
exports.UseCaseDefinitionToJSON = exports.UseCaseDefinitionFromJSONTyped = exports.UseCaseDefinitionFromJSON = exports.instanceOfUseCaseDefinition = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the UseCaseDefinition interface.
 */
function instanceOfUseCaseDefinition(value) {
    let isInstance = true;
...
exports.instanceOfUseCaseDefinition = instanceOfUseCaseDefinition;
function UseCaseDefinitionFromJSON(json) {
    return UseCaseDefinitionFromJSONTyped(json, false);
}
exports.UseCaseDefinitionFromJSON = UseCaseDefinitionFromJSON;
function UseCaseDefinitionFromJSONTyped(json, ignoreDiscriminator) {
...
exports.UseCaseDefinitionFromJSONTyped = UseCaseDefinitionFromJSONTyped;
function UseCaseDefinitionToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.UseCaseDefinitionToJSON = UseCaseDefinitionToJSON;
