...
exports.MergeNodeToJSON = exports.MergeNodeFromJSONTyped = exports.MergeNodeFromJSON = exports.instanceOfMergeNode = void 0;
/**
 * Check if a given object implements the MergeNode interface.
 */
function instanceOfMergeNode(value) {
    let isInstance = true;
...
exports.instanceOfMergeNode = instanceOfMergeNode;
function MergeNodeFromJSON(json) {
    return MergeNodeFromJSONTyped(json, false);
}
exports.MergeNodeFromJSON = MergeNodeFromJSON;
function MergeNodeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.MergeNodeFromJSONTyped = MergeNodeFromJSONTyped;
function MergeNodeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.MergeNodeToJSON = MergeNodeToJSON;
