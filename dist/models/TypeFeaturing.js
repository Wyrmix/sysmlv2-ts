...
exports.TypeFeaturingToJSON = exports.TypeFeaturingFromJSONTyped = exports.TypeFeaturingFromJSON = exports.instanceOfTypeFeaturing = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the TypeFeaturing interface.
 */
function instanceOfTypeFeaturing(value) {
    let isInstance = true;
...
exports.instanceOfTypeFeaturing = instanceOfTypeFeaturing;
function TypeFeaturingFromJSON(json) {
    return TypeFeaturingFromJSONTyped(json, false);
}
exports.TypeFeaturingFromJSON = TypeFeaturingFromJSON;
function TypeFeaturingFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'featureOfType': (0, Identified_1.IdentifiedFromJSON)(json['featureOfType']),
        'featuringType': (0, Identified_1.IdentifiedFromJSON)(json['featuringType']),
...
exports.TypeFeaturingFromJSONTyped = TypeFeaturingFromJSONTyped;
function TypeFeaturingToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.TypeFeaturingToJSON = TypeFeaturingToJSON;
