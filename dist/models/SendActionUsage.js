...
exports.SendActionUsageToJSON = exports.SendActionUsageFromJSONTyped = exports.SendActionUsageFromJSON = exports.instanceOfSendActionUsage = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the SendActionUsage interface.
 */
function instanceOfSendActionUsage(value) {
    let isInstance = true;
...
exports.instanceOfSendActionUsage = instanceOfSendActionUsage;
function SendActionUsageFromJSON(json) {
    return SendActionUsageFromJSONTyped(json, false);
}
exports.SendActionUsageFromJSON = SendActionUsageFromJSON;
function SendActionUsageFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'payloadArgument': (0, Identified_1.IdentifiedFromJSON)(json['payloadArgument']),
...
exports.SendActionUsageFromJSONTyped = SendActionUsageFromJSONTyped;
function SendActionUsageToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.SendActionUsageToJSON = SendActionUsageToJSON;
