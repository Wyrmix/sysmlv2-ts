...
exports.ReferenceUsageRequestToJSON = exports.ReferenceUsageRequestFromJSONTyped = exports.ReferenceUsageRequestFromJSON = exports.instanceOfReferenceUsageRequest = void 0;
const runtime_1 = require("../runtime");
/**
 * Check if a given object implements the ReferenceUsageRequest interface.
 */
function instanceOfReferenceUsageRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfReferenceUsageRequest = instanceOfReferenceUsageRequest;
function ReferenceUsageRequestFromJSON(json) {
    return ReferenceUsageRequestFromJSONTyped(json, false);
}
exports.ReferenceUsageRequestFromJSON = ReferenceUsageRequestFromJSON;
function ReferenceUsageRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.ReferenceUsageRequestFromJSONTyped = ReferenceUsageRequestFromJSONTyped;
function ReferenceUsageRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ReferenceUsageRequestToJSON = ReferenceUsageRequestToJSON;
