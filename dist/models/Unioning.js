...
exports.UnioningToJSON = exports.UnioningFromJSONTyped = exports.UnioningFromJSON = exports.instanceOfUnioning = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the Unioning interface.
 */
function instanceOfUnioning(value) {
    let isInstance = true;
...
exports.instanceOfUnioning = instanceOfUnioning;
function UnioningFromJSON(json) {
    return UnioningFromJSONTyped(json, false);
}
exports.UnioningFromJSON = UnioningFromJSON;
function UnioningFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'typeUnioned': (0, Identified_1.IdentifiedFromJSON)(json['typeUnioned']),
        'unioningType': (0, Identified_1.IdentifiedFromJSON)(json['unioningType']),
    };
}
exports.UnioningFromJSONTyped = UnioningFromJSONTyped;
function UnioningToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.UnioningToJSON = UnioningToJSON;
