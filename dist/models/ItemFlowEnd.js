...
exports.ItemFlowEndToJSON = exports.ItemFlowEndFromJSONTyped = exports.ItemFlowEndFromJSON = exports.instanceOfItemFlowEnd = void 0;
/**
 * Check if a given object implements the ItemFlowEnd interface.
 */
function instanceOfItemFlowEnd(value) {
    let isInstance = true;
...
exports.instanceOfItemFlowEnd = instanceOfItemFlowEnd;
function ItemFlowEndFromJSON(json) {
    return ItemFlowEndFromJSONTyped(json, false);
}
exports.ItemFlowEndFromJSON = ItemFlowEndFromJSON;
function ItemFlowEndFromJSONTyped(json, ignoreDiscriminator) {
...
exports.ItemFlowEndFromJSONTyped = ItemFlowEndFromJSONTyped;
function ItemFlowEndToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ItemFlowEndToJSON = ItemFlowEndToJSON;
