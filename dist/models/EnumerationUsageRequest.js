...
exports.EnumerationUsageRequestToJSON = exports.EnumerationUsageRequestFromJSONTyped = exports.EnumerationUsageRequestFromJSON = exports.instanceOfEnumerationUsageRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the EnumerationUsageRequest interface.
 */
function instanceOfEnumerationUsageRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfEnumerationUsageRequest = instanceOfEnumerationUsageRequest;
function EnumerationUsageRequestFromJSON(json) {
    return EnumerationUsageRequestFromJSONTyped(json, false);
}
exports.EnumerationUsageRequestFromJSON = EnumerationUsageRequestFromJSON;
function EnumerationUsageRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'attributeDefinition': !(0, runtime_1.exists)(json, 'attributeDefinition') ? undefined : json['attributeDefinition'],
        ...
        'enumerationDefinition': !(0, runtime_1.exists)(json, 'enumerationDefinition') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['enumerationDefinition']),
...
exports.EnumerationUsageRequestFromJSONTyped = EnumerationUsageRequestFromJSONTyped;
function EnumerationUsageRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'enumerationDefinition': (0, Identified_1.IdentifiedToJSON)(value.enumerationDefinition),
...
exports.EnumerationUsageRequestToJSON = EnumerationUsageRequestToJSON;
