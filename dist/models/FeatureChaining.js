...
exports.FeatureChainingToJSON = exports.FeatureChainingFromJSONTyped = exports.FeatureChainingFromJSON = exports.instanceOfFeatureChaining = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the FeatureChaining interface.
 */
function instanceOfFeatureChaining(value) {
    let isInstance = true;
...
exports.instanceOfFeatureChaining = instanceOfFeatureChaining;
function FeatureChainingFromJSON(json) {
    return FeatureChainingFromJSONTyped(json, false);
}
exports.FeatureChainingFromJSON = FeatureChainingFromJSON;
function FeatureChainingFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'chainingFeature': (0, Identified_1.IdentifiedFromJSON)(json['chainingFeature']),
        'declaredName': json['declaredName'],
        'declaredShortName': json['declaredShortName'],
        'documentation': json['documentation'],
        'elementId': json['elementId'],
        'featureChained': (0, Identified_1.IdentifiedFromJSON)(json['featureChained']),
...
exports.FeatureChainingFromJSONTyped = FeatureChainingFromJSONTyped;
function FeatureChainingToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.FeatureChainingToJSON = FeatureChainingToJSON;
