...
exports.DifferencingRequestToJSON = exports.DifferencingRequestFromJSONTyped = exports.DifferencingRequestFromJSON = exports.instanceOfDifferencingRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the DifferencingRequest interface.
 */
function instanceOfDifferencingRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfDifferencingRequest = instanceOfDifferencingRequest;
function DifferencingRequestFromJSON(json) {
    return DifferencingRequestFromJSONTyped(json, false);
}
exports.DifferencingRequestFromJSON = DifferencingRequestFromJSON;
function DifferencingRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'differencingType': !(0, runtime_1.exists)(json, 'differencingType') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['differencingType']),
        ...
        'typeDifferenced': !(0, runtime_1.exists)(json, 'typeDifferenced') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['typeDifferenced']),
    };
}
exports.DifferencingRequestFromJSONTyped = DifferencingRequestFromJSONTyped;
function DifferencingRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'differencingType': (0, Identified_1.IdentifiedToJSON)(value.differencingType),
        ...
        'typeDifferenced': (0, Identified_1.IdentifiedToJSON)(value.typeDifferenced),
    };
}
exports.DifferencingRequestToJSON = DifferencingRequestToJSON;
