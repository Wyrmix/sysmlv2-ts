...
exports.ResultExpressionMembershipToJSON = exports.ResultExpressionMembershipFromJSONTyped = exports.ResultExpressionMembershipFromJSON = exports.instanceOfResultExpressionMembership = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the ResultExpressionMembership interface.
 */
function instanceOfResultExpressionMembership(value) {
    let isInstance = true;
...
exports.instanceOfResultExpressionMembership = instanceOfResultExpressionMembership;
function ResultExpressionMembershipFromJSON(json) {
    return ResultExpressionMembershipFromJSONTyped(json, false);
}
exports.ResultExpressionMembershipFromJSON = ResultExpressionMembershipFromJSON;
function ResultExpressionMembershipFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'ownedResultExpression': (0, Identified_1.IdentifiedFromJSON)(json['ownedResultExpression']),
        'owner': json['owner'],
...
exports.ResultExpressionMembershipFromJSONTyped = ResultExpressionMembershipFromJSONTyped;
function ResultExpressionMembershipToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ResultExpressionMembershipToJSON = ResultExpressionMembershipToJSON;
