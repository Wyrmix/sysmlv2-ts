...
exports.AllocationDefinitionRequestToJSON = exports.AllocationDefinitionRequestFromJSONTyped = exports.AllocationDefinitionRequestFromJSON = exports.instanceOfAllocationDefinitionRequest = void 0;
const runtime_1 = require("../runtime");
/**
 * Check if a given object implements the AllocationDefinitionRequest interface.
 */
function instanceOfAllocationDefinitionRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfAllocationDefinitionRequest = instanceOfAllocationDefinitionRequest;
function AllocationDefinitionRequestFromJSON(json) {
    return AllocationDefinitionRequestFromJSONTyped(json, false);
}
exports.AllocationDefinitionRequestFromJSON = AllocationDefinitionRequestFromJSON;
function AllocationDefinitionRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.AllocationDefinitionRequestFromJSONTyped = AllocationDefinitionRequestFromJSONTyped;
function AllocationDefinitionRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.AllocationDefinitionRequestToJSON = AllocationDefinitionRequestToJSON;
