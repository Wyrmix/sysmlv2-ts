...
exports.AssignmentActionUsageToJSON = exports.AssignmentActionUsageFromJSONTyped = exports.AssignmentActionUsageFromJSON = exports.instanceOfAssignmentActionUsage = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the AssignmentActionUsage interface.
 */
function instanceOfAssignmentActionUsage(value) {
    let isInstance = true;
...
exports.instanceOfAssignmentActionUsage = instanceOfAssignmentActionUsage;
function AssignmentActionUsageFromJSON(json) {
    return AssignmentActionUsageFromJSONTyped(json, false);
}
exports.AssignmentActionUsageFromJSON = AssignmentActionUsageFromJSON;
function AssignmentActionUsageFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'targetArgument': (0, Identified_1.IdentifiedFromJSON)(json['targetArgument']),
        'textualRepresentation': json['textualRepresentation'],
        'type': json['type'],
        'unioningType': json['unioningType'],
        'usage': json['usage'],
        'valueExpression': (0, Identified_1.IdentifiedFromJSON)(json['valueExpression']),
        'variant': json['variant'],
        'variantMembership': json['variantMembership'],
    };
}
exports.AssignmentActionUsageFromJSONTyped = AssignmentActionUsageFromJSONTyped;
function AssignmentActionUsageToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.AssignmentActionUsageToJSON = AssignmentActionUsageToJSON;
