...
exports.SubjectMembershipToJSON = exports.SubjectMembershipFromJSONTyped = exports.SubjectMembershipFromJSON = exports.instanceOfSubjectMembership = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the SubjectMembership interface.
 */
function instanceOfSubjectMembership(value) {
    let isInstance = true;
...
exports.instanceOfSubjectMembership = instanceOfSubjectMembership;
function SubjectMembershipFromJSON(json) {
    return SubjectMembershipFromJSONTyped(json, false);
}
exports.SubjectMembershipFromJSON = SubjectMembershipFromJSON;
function SubjectMembershipFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'ownedSubjectParameter': (0, Identified_1.IdentifiedFromJSON)(json['ownedSubjectParameter']),
        'owner': json['owner'],
...
exports.SubjectMembershipFromJSONTyped = SubjectMembershipFromJSONTyped;
function SubjectMembershipToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'ownedSubjectParameter': (0, Identified_1.IdentifiedToJSON)(value.ownedSubjectParameter),
        'owner': value.owner,
...
exports.SubjectMembershipToJSON = SubjectMembershipToJSON;
