...
exports.ActorMembershipToJSON = exports.ActorMembershipFromJSONTyped = exports.ActorMembershipFromJSON = exports.instanceOfActorMembership = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the ActorMembership interface.
 */
function instanceOfActorMembership(value) {
    let isInstance = true;
...
exports.instanceOfActorMembership = instanceOfActorMembership;
function ActorMembershipFromJSON(json) {
    return ActorMembershipFromJSONTyped(json, false);
}
exports.ActorMembershipFromJSON = ActorMembershipFromJSON;
function ActorMembershipFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'name': json['name'],
        'ownedActorParameter': (0, Identified_1.IdentifiedFromJSON)(json['ownedActorParameter']),
...
exports.ActorMembershipFromJSONTyped = ActorMembershipFromJSONTyped;
function ActorMembershipToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ActorMembershipToJSON = ActorMembershipToJSON;
