...
exports.IncludeUseCaseUsageToJSON = exports.IncludeUseCaseUsageFromJSONTyped = exports.IncludeUseCaseUsageFromJSON = exports.instanceOfIncludeUseCaseUsage = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the IncludeUseCaseUsage interface.
 */
function instanceOfIncludeUseCaseUsage(value) {
    let isInstance = true;
...
exports.instanceOfIncludeUseCaseUsage = instanceOfIncludeUseCaseUsage;
function IncludeUseCaseUsageFromJSON(json) {
    return IncludeUseCaseUsageFromJSONTyped(json, false);
}
exports.IncludeUseCaseUsageFromJSON = IncludeUseCaseUsageFromJSON;
function IncludeUseCaseUsageFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'useCaseIncluded': (0, Identified_1.IdentifiedFromJSON)(json['useCaseIncluded']),
        'variant': json['variant'],
        'variantMembership': json['variantMembership'],
    };
}
exports.IncludeUseCaseUsageFromJSONTyped = IncludeUseCaseUsageFromJSONTyped;
function IncludeUseCaseUsageToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.IncludeUseCaseUsageToJSON = IncludeUseCaseUsageToJSON;
