...
exports.LiteralRationalRequestToJSON = exports.LiteralRationalRequestFromJSONTyped = exports.LiteralRationalRequestFromJSON = exports.instanceOfLiteralRationalRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the LiteralRationalRequest interface.
 */
function instanceOfLiteralRationalRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfLiteralRationalRequest = instanceOfLiteralRationalRequest;
function LiteralRationalRequestFromJSON(json) {
    return LiteralRationalRequestFromJSONTyped(json, false);
}
exports.LiteralRationalRequestFromJSON = LiteralRationalRequestFromJSON;
function LiteralRationalRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.LiteralRationalRequestFromJSONTyped = LiteralRationalRequestFromJSONTyped;
function LiteralRationalRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.LiteralRationalRequestToJSON = LiteralRationalRequestToJSON;
