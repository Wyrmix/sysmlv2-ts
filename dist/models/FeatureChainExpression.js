...
exports.FeatureChainExpressionToJSON = exports.FeatureChainExpressionFromJSONTyped = exports.FeatureChainExpressionFromJSON = exports.instanceOfFeatureChainExpression = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the FeatureChainExpression interface.
 */
function instanceOfFeatureChainExpression(value) {
    let isInstance = true;
...
exports.instanceOfFeatureChainExpression = instanceOfFeatureChainExpression;
function FeatureChainExpressionFromJSON(json) {
    return FeatureChainExpressionFromJSONTyped(json, false);
}
exports.FeatureChainExpressionFromJSON = FeatureChainExpressionFromJSON;
function FeatureChainExpressionFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'targetFeature': (0, Identified_1.IdentifiedFromJSON)(json['targetFeature']),
        'textualRepresentation': json['textualRepresentation'],
        'type': json['type'],
        'unioningType': json['unioningType'],
    };
}
exports.FeatureChainExpressionFromJSONTyped = FeatureChainExpressionFromJSONTyped;
function FeatureChainExpressionToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.FeatureChainExpressionToJSON = FeatureChainExpressionToJSON;
