...
exports.EnumerationDefinitionToJSON = exports.EnumerationDefinitionFromJSONTyped = exports.EnumerationDefinitionFromJSON = exports.instanceOfEnumerationDefinition = void 0;
/**
 * Check if a given object implements the EnumerationDefinition interface.
 */
function instanceOfEnumerationDefinition(value) {
    let isInstance = true;
...
exports.instanceOfEnumerationDefinition = instanceOfEnumerationDefinition;
function EnumerationDefinitionFromJSON(json) {
    return EnumerationDefinitionFromJSONTyped(json, false);
}
exports.EnumerationDefinitionFromJSON = EnumerationDefinitionFromJSON;
function EnumerationDefinitionFromJSONTyped(json, ignoreDiscriminator) {
...
exports.EnumerationDefinitionFromJSONTyped = EnumerationDefinitionFromJSONTyped;
function EnumerationDefinitionToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.EnumerationDefinitionToJSON = EnumerationDefinitionToJSON;
