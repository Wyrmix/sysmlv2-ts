...
exports.TransitionUsageToJSON = exports.TransitionUsageFromJSONTyped = exports.TransitionUsageFromJSON = exports.instanceOfTransitionUsage = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the TransitionUsage interface.
 */
function instanceOfTransitionUsage(value) {
    let isInstance = true;
    ...
    isInstance = isInstance && "effectAction" in value;
    ...
    isInstance = isInstance && "succession" in value;
    isInstance = isInstance && "target" in value;
    isInstance = isInstance && "textualRepresentation" in value;
    isInstance = isInstance && "triggerAction" in value;
    isInstance = isInstance && "type" in value;
...
exports.instanceOfTransitionUsage = instanceOfTransitionUsage;
function TransitionUsageFromJSON(json) {
    return TransitionUsageFromJSONTyped(json, false);
}
exports.TransitionUsageFromJSON = TransitionUsageFromJSON;
function TransitionUsageFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'effectAction': json['effectAction'],
        ...
        'source': (0, Identified_1.IdentifiedFromJSON)(json['source']),
        'succession': (0, Identified_1.IdentifiedFromJSON)(json['succession']),
        'target': (0, Identified_1.IdentifiedFromJSON)(json['target']),
...
exports.TransitionUsageFromJSONTyped = TransitionUsageFromJSONTyped;
function TransitionUsageToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.TransitionUsageToJSON = TransitionUsageToJSON;
