...
exports.ElementFilterMembershipToJSON = exports.ElementFilterMembershipFromJSONTyped = exports.ElementFilterMembershipFromJSON = exports.instanceOfElementFilterMembership = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the ElementFilterMembership interface.
 */
function instanceOfElementFilterMembership(value) {
    let isInstance = true;
...
exports.instanceOfElementFilterMembership = instanceOfElementFilterMembership;
function ElementFilterMembershipFromJSON(json) {
    return ElementFilterMembershipFromJSONTyped(json, false);
}
exports.ElementFilterMembershipFromJSON = ElementFilterMembershipFromJSON;
function ElementFilterMembershipFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'condition': (0, Identified_1.IdentifiedFromJSON)(json['condition']),
...
exports.ElementFilterMembershipFromJSONTyped = ElementFilterMembershipFromJSONTyped;
function ElementFilterMembershipToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ElementFilterMembershipToJSON = ElementFilterMembershipToJSON;
