...
exports.StateDefinitionToJSON = exports.StateDefinitionFromJSONTyped = exports.StateDefinitionFromJSON = exports.instanceOfStateDefinition = void 0;
/**
 * Check if a given object implements the StateDefinition interface.
 */
function instanceOfStateDefinition(value) {
    let isInstance = true;
...
exports.instanceOfStateDefinition = instanceOfStateDefinition;
function StateDefinitionFromJSON(json) {
    return StateDefinitionFromJSONTyped(json, false);
}
exports.StateDefinitionFromJSON = StateDefinitionFromJSON;
function StateDefinitionFromJSONTyped(json, ignoreDiscriminator) {
...
exports.StateDefinitionFromJSONTyped = StateDefinitionFromJSONTyped;
function StateDefinitionToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.StateDefinitionToJSON = StateDefinitionToJSON;
