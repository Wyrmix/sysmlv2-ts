...
exports.ConcernDefinitionToJSON = exports.ConcernDefinitionFromJSONTyped = exports.ConcernDefinitionFromJSON = exports.instanceOfConcernDefinition = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the ConcernDefinition interface.
 */
function instanceOfConcernDefinition(value) {
    let isInstance = true;
...
exports.instanceOfConcernDefinition = instanceOfConcernDefinition;
function ConcernDefinitionFromJSON(json) {
    return ConcernDefinitionFromJSONTyped(json, false);
}
exports.ConcernDefinitionFromJSON = ConcernDefinitionFromJSON;
function ConcernDefinitionFromJSONTyped(json, ignoreDiscriminator) {
...
exports.ConcernDefinitionFromJSONTyped = ConcernDefinitionFromJSONTyped;
function ConcernDefinitionToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ConcernDefinitionToJSON = ConcernDefinitionToJSON;
