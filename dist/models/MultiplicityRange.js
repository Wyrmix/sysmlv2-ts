...
exports.MultiplicityRangeToJSON = exports.MultiplicityRangeFromJSONTyped = exports.MultiplicityRangeFromJSON = exports.instanceOfMultiplicityRange = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the MultiplicityRange interface.
 */
function instanceOfMultiplicityRange(value) {
    let isInstance = true;
...
exports.instanceOfMultiplicityRange = instanceOfMultiplicityRange;
function MultiplicityRangeFromJSON(json) {
    return MultiplicityRangeFromJSONTyped(json, false);
}
exports.MultiplicityRangeFromJSON = MultiplicityRangeFromJSON;
function MultiplicityRangeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'upperBound': (0, Identified_1.IdentifiedFromJSON)(json['upperBound']),
    };
}
exports.MultiplicityRangeFromJSONTyped = MultiplicityRangeFromJSONTyped;
function MultiplicityRangeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.MultiplicityRangeToJSON = MultiplicityRangeToJSON;
