...
exports.AcceptActionUsageToJSON = exports.AcceptActionUsageFromJSONTyped = exports.AcceptActionUsageFromJSON = exports.instanceOfAcceptActionUsage = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the AcceptActionUsage interface.
 */
function instanceOfAcceptActionUsage(value) {
    let isInstance = true;
    ...
    isInstance = isInstance && "payloadParameter" in value;
...
exports.instanceOfAcceptActionUsage = instanceOfAcceptActionUsage;
function AcceptActionUsageFromJSON(json) {
    return AcceptActionUsageFromJSONTyped(json, false);
}
exports.AcceptActionUsageFromJSON = AcceptActionUsageFromJSON;
function AcceptActionUsageFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'payloadArgument': json['payloadArgument'],
        'payloadParameter': (0, Identified_1.IdentifiedFromJSON)(json['payloadParameter']),
...
exports.AcceptActionUsageFromJSONTyped = AcceptActionUsageFromJSONTyped;
function AcceptActionUsageToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.AcceptActionUsageToJSON = AcceptActionUsageToJSON;
