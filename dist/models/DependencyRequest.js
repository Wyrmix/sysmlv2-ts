...
exports.DependencyRequestToJSON = exports.DependencyRequestFromJSONTyped = exports.DependencyRequestFromJSON = exports.instanceOfDependencyRequest = void 0;
const runtime_1 = require("../runtime");
/**
 * Check if a given object implements the DependencyRequest interface.
 */
function instanceOfDependencyRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfDependencyRequest = instanceOfDependencyRequest;
function DependencyRequestFromJSON(json) {
    return DependencyRequestFromJSONTyped(json, false);
}
exports.DependencyRequestFromJSON = DependencyRequestFromJSON;
function DependencyRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'client': !(0, runtime_1.exists)(json, 'client') ? undefined : json['client'],
        ...
        'supplier': !(0, runtime_1.exists)(json, 'supplier') ? undefined : json['supplier'],
...
exports.DependencyRequestFromJSONTyped = DependencyRequestFromJSONTyped;
function DependencyRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.DependencyRequestToJSON = DependencyRequestToJSON;
