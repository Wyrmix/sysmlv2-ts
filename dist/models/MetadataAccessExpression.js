...
exports.MetadataAccessExpressionToJSON = exports.MetadataAccessExpressionFromJSONTyped = exports.MetadataAccessExpressionFromJSON = exports.instanceOfMetadataAccessExpression = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the MetadataAccessExpression interface.
 */
function instanceOfMetadataAccessExpression(value) {
    let isInstance = true;
...
exports.instanceOfMetadataAccessExpression = instanceOfMetadataAccessExpression;
function MetadataAccessExpressionFromJSON(json) {
    return MetadataAccessExpressionFromJSONTyped(json, false);
}
exports.MetadataAccessExpressionFromJSON = MetadataAccessExpressionFromJSON;
function MetadataAccessExpressionFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'referencedElement': (0, Identified_1.IdentifiedFromJSON)(json['referencedElement']),
...
exports.MetadataAccessExpressionFromJSONTyped = MetadataAccessExpressionFromJSONTyped;
function MetadataAccessExpressionToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.MetadataAccessExpressionToJSON = MetadataAccessExpressionToJSON;
