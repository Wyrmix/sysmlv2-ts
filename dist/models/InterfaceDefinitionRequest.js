...
exports.InterfaceDefinitionRequestToJSON = exports.InterfaceDefinitionRequestFromJSONTyped = exports.InterfaceDefinitionRequestFromJSON = exports.instanceOfInterfaceDefinitionRequest = void 0;
const runtime_1 = require("../runtime");
/**
 * Check if a given object implements the InterfaceDefinitionRequest interface.
 */
function instanceOfInterfaceDefinitionRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfInterfaceDefinitionRequest = instanceOfInterfaceDefinitionRequest;
function InterfaceDefinitionRequestFromJSON(json) {
    return InterfaceDefinitionRequestFromJSONTyped(json, false);
}
exports.InterfaceDefinitionRequestFromJSON = InterfaceDefinitionRequestFromJSON;
function InterfaceDefinitionRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'associationEnd': !(0, runtime_1.exists)(json, 'associationEnd') ? undefined : json['associationEnd'],
        'connectionEnd': !(0, runtime_1.exists)(json, 'connectionEnd') ? undefined : json['connectionEnd'],
        ...
        'interfaceEnd': !(0, runtime_1.exists)(json, 'interfaceEnd') ? undefined : json['interfaceEnd'],
        ...
        'relatedType': !(0, runtime_1.exists)(json, 'relatedType') ? undefined : json['relatedType'],
...
exports.InterfaceDefinitionRequestFromJSONTyped = InterfaceDefinitionRequestFromJSONTyped;
function InterfaceDefinitionRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.InterfaceDefinitionRequestToJSON = InterfaceDefinitionRequestToJSON;
