...
exports.SendActionUsageRequestToJSON = exports.SendActionUsageRequestFromJSONTyped = exports.SendActionUsageRequestFromJSON = exports.instanceOfSendActionUsageRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the SendActionUsageRequest interface.
 */
function instanceOfSendActionUsageRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfSendActionUsageRequest = instanceOfSendActionUsageRequest;
function SendActionUsageRequestFromJSON(json) {
    return SendActionUsageRequestFromJSONTyped(json, false);
}
exports.SendActionUsageRequestFromJSON = SendActionUsageRequestFromJSON;
function SendActionUsageRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'payloadArgument': !(0, runtime_1.exists)(json, 'payloadArgument') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['payloadArgument']),
        ...
        'senderArgument': !(0, runtime_1.exists)(json, 'senderArgument') ? undefined : json['senderArgument'],
...
exports.SendActionUsageRequestFromJSONTyped = SendActionUsageRequestFromJSONTyped;
function SendActionUsageRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'payloadArgument': (0, Identified_1.IdentifiedToJSON)(value.payloadArgument),
...
exports.SendActionUsageRequestToJSON = SendActionUsageRequestToJSON;
