...
exports.AllocationUsageRequestToJSON = exports.AllocationUsageRequestFromJSONTyped = exports.AllocationUsageRequestFromJSON = exports.instanceOfAllocationUsageRequest = void 0;
const runtime_1 = require("../runtime");
/**
 * Check if a given object implements the AllocationUsageRequest interface.
 */
function instanceOfAllocationUsageRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfAllocationUsageRequest = instanceOfAllocationUsageRequest;
function AllocationUsageRequestFromJSON(json) {
    return AllocationUsageRequestFromJSONTyped(json, false);
}
exports.AllocationUsageRequestFromJSON = AllocationUsageRequestFromJSON;
function AllocationUsageRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'allocationDefinition': !(0, runtime_1.exists)(json, 'allocationDefinition') ? undefined : json['allocationDefinition'],
...
exports.AllocationUsageRequestFromJSONTyped = AllocationUsageRequestFromJSONTyped;
function AllocationUsageRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.AllocationUsageRequestToJSON = AllocationUsageRequestToJSON;
