...
exports.FeatureValueToJSON = exports.FeatureValueFromJSONTyped = exports.FeatureValueFromJSON = exports.instanceOfFeatureValue = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the FeatureValue interface.
 */
function instanceOfFeatureValue(value) {
    let isInstance = true;
...
exports.instanceOfFeatureValue = instanceOfFeatureValue;
function FeatureValueFromJSON(json) {
    return FeatureValueFromJSONTyped(json, false);
}
exports.FeatureValueFromJSON = FeatureValueFromJSON;
function FeatureValueFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'featureWithValue': (0, Identified_1.IdentifiedFromJSON)(json['featureWithValue']),
        ...
        'value': (0, Identified_1.IdentifiedFromJSON)(json['value']),
        'visibility': json['visibility'],
    };
}
exports.FeatureValueFromJSONTyped = FeatureValueFromJSONTyped;
function FeatureValueToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.FeatureValueToJSON = FeatureValueToJSON;
