...
exports.InterfaceUsageRequestToJSON = exports.InterfaceUsageRequestFromJSONTyped = exports.InterfaceUsageRequestFromJSON = exports.instanceOfInterfaceUsageRequest = void 0;
const runtime_1 = require("../runtime");
/**
 * Check if a given object implements the InterfaceUsageRequest interface.
 */
function instanceOfInterfaceUsageRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfInterfaceUsageRequest = instanceOfInterfaceUsageRequest;
function InterfaceUsageRequestFromJSON(json) {
    return InterfaceUsageRequestFromJSONTyped(json, false);
}
exports.InterfaceUsageRequestFromJSON = InterfaceUsageRequestFromJSON;
function InterfaceUsageRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'interfaceDefinition': !(0, runtime_1.exists)(json, 'interfaceDefinition') ? undefined : json['interfaceDefinition'],
...
exports.InterfaceUsageRequestFromJSONTyped = InterfaceUsageRequestFromJSONTyped;
function InterfaceUsageRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.InterfaceUsageRequestToJSON = InterfaceUsageRequestToJSON;
