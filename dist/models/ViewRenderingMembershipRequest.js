...
exports.ViewRenderingMembershipRequestToJSON = exports.ViewRenderingMembershipRequestFromJSONTyped = exports.ViewRenderingMembershipRequestFromJSON = exports.instanceOfViewRenderingMembershipRequest = void 0;
 ...
 */
function instanceOfViewRenderingMembershipRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfViewRenderingMembershipRequest = instanceOfViewRenderingMembershipRequest;
function ViewRenderingMembershipRequestFromJSON(json) {
    return ViewRenderingMembershipRequestFromJSONTyped(json, false);
}
exports.ViewRenderingMembershipRequestFromJSON = ViewRenderingMembershipRequestFromJSON;
function ViewRenderingMembershipRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'ownedRendering': !(0, runtime_1.exists)(json, 'ownedRendering') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['ownedRendering']),
        ...
        'referencedRendering': !(0, runtime_1.exists)(json, 'referencedRendering') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['referencedRendering']),
...
exports.ViewRenderingMembershipRequestFromJSONTyped = ViewRenderingMembershipRequestFromJSONTyped;
function ViewRenderingMembershipRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ViewRenderingMembershipRequestToJSON = ViewRenderingMembershipRequestToJSON;
