...
exports.JoinNodeToJSON = exports.JoinNodeFromJSONTyped = exports.JoinNodeFromJSON = exports.instanceOfJoinNode = void 0;
/**
 * Check if a given object implements the JoinNode interface.
 */
function instanceOfJoinNode(value) {
    let isInstance = true;
...
exports.instanceOfJoinNode = instanceOfJoinNode;
function JoinNodeFromJSON(json) {
    return JoinNodeFromJSONTyped(json, false);
}
exports.JoinNodeFromJSON = JoinNodeFromJSON;
function JoinNodeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.JoinNodeFromJSONTyped = JoinNodeFromJSONTyped;
function JoinNodeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.JoinNodeToJSON = JoinNodeToJSON;
