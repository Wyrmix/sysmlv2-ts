...
exports.SatisfyRequirementUsageRequestToJSON = exports.SatisfyRequirementUsageRequestFromJSONTyped = exports.SatisfyRequirementUsageRequestFromJSON = exports.instanceOfSatisfyRequirementUsageRequest = void 0;
 ...
 */
function instanceOfSatisfyRequirementUsageRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfSatisfyRequirementUsageRequest = instanceOfSatisfyRequirementUsageRequest;
function SatisfyRequirementUsageRequestFromJSON(json) {
    return SatisfyRequirementUsageRequestFromJSONTyped(json, false);
}
exports.SatisfyRequirementUsageRequestFromJSON = SatisfyRequirementUsageRequestFromJSON;
function SatisfyRequirementUsageRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'assertedConstraint': !(0, runtime_1.exists)(json, 'assertedConstraint') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['assertedConstraint']),
        ...
        'constraintDefinition': !(0, runtime_1.exists)(json, 'constraintDefinition') ? undefined : json['constraintDefinition'],
        ...
        'isNegated': !(0, runtime_1.exists)(json, 'isNegated') ? undefined : json['isNegated'],
        ...
        'requirementDefinition': !(0, runtime_1.exists)(json, 'requirementDefinition') ? undefined : json['requirementDefinition'],
        'result': !(0, runtime_1.exists)(json, 'result') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['result']),
        'satisfiedRequirement': !(0, runtime_1.exists)(json, 'satisfiedRequirement') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['satisfiedRequirement']),
        'satisfyingFeature': !(0, runtime_1.exists)(json, 'satisfyingFeature') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['satisfyingFeature']),
...
exports.SatisfyRequirementUsageRequestFromJSONTyped = SatisfyRequirementUsageRequestFromJSONTyped;
function SatisfyRequirementUsageRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'assertedConstraint': (0, Identified_1.IdentifiedToJSON)(value.assertedConstraint),
        ...
        'satisfiedRequirement': (0, Identified_1.IdentifiedToJSON)(value.satisfiedRequirement),
        'satisfyingFeature': (0, Identified_1.IdentifiedToJSON)(value.satisfyingFeature),
...
exports.SatisfyRequirementUsageRequestToJSON = SatisfyRequirementUsageRequestToJSON;
