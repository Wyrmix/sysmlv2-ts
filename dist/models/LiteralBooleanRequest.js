...
exports.LiteralBooleanRequestToJSON = exports.LiteralBooleanRequestFromJSONTyped = exports.LiteralBooleanRequestFromJSON = exports.instanceOfLiteralBooleanRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the LiteralBooleanRequest interface.
 */
function instanceOfLiteralBooleanRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfLiteralBooleanRequest = instanceOfLiteralBooleanRequest;
function LiteralBooleanRequestFromJSON(json) {
    return LiteralBooleanRequestFromJSONTyped(json, false);
}
exports.LiteralBooleanRequestFromJSON = LiteralBooleanRequestFromJSON;
function LiteralBooleanRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.LiteralBooleanRequestFromJSONTyped = LiteralBooleanRequestFromJSONTyped;
function LiteralBooleanRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.LiteralBooleanRequestToJSON = LiteralBooleanRequestToJSON;
