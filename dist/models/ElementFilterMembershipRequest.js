...
exports.ElementFilterMembershipRequestToJSON = exports.ElementFilterMembershipRequestFromJSONTyped = exports.ElementFilterMembershipRequestFromJSON = exports.instanceOfElementFilterMembershipRequest = void 0;
 ...
 */
function instanceOfElementFilterMembershipRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfElementFilterMembershipRequest = instanceOfElementFilterMembershipRequest;
function ElementFilterMembershipRequestFromJSON(json) {
    return ElementFilterMembershipRequestFromJSONTyped(json, false);
}
exports.ElementFilterMembershipRequestFromJSON = ElementFilterMembershipRequestFromJSON;
function ElementFilterMembershipRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'condition': !(0, runtime_1.exists)(json, 'condition') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['condition']),
...
exports.ElementFilterMembershipRequestFromJSONTyped = ElementFilterMembershipRequestFromJSONTyped;
function ElementFilterMembershipRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'condition': (0, Identified_1.IdentifiedToJSON)(value.condition),
...
exports.ElementFilterMembershipRequestToJSON = ElementFilterMembershipRequestToJSON;
