...
exports.InterfaceUsageToJSON = exports.InterfaceUsageFromJSONTyped = exports.InterfaceUsageFromJSON = exports.instanceOfInterfaceUsage = void 0;
/**
 * Check if a given object implements the InterfaceUsage interface.
 */
function instanceOfInterfaceUsage(value) {
    let isInstance = true;
...
exports.instanceOfInterfaceUsage = instanceOfInterfaceUsage;
function InterfaceUsageFromJSON(json) {
    return InterfaceUsageFromJSONTyped(json, false);
}
exports.InterfaceUsageFromJSON = InterfaceUsageFromJSON;
function InterfaceUsageFromJSONTyped(json, ignoreDiscriminator) {
...
exports.InterfaceUsageFromJSONTyped = InterfaceUsageFromJSONTyped;
function InterfaceUsageToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.InterfaceUsageToJSON = InterfaceUsageToJSON;
