...
exports.VerificationCaseUsageRequestToJSON = exports.VerificationCaseUsageRequestFromJSONTyped = exports.VerificationCaseUsageRequestFromJSON = exports.instanceOfVerificationCaseUsageRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the VerificationCaseUsageRequest interface.
 */
function instanceOfVerificationCaseUsageRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfVerificationCaseUsageRequest = instanceOfVerificationCaseUsageRequest;
function VerificationCaseUsageRequestFromJSON(json) {
    return VerificationCaseUsageRequestFromJSONTyped(json, false);
}
exports.VerificationCaseUsageRequestFromJSON = VerificationCaseUsageRequestFromJSON;
function VerificationCaseUsageRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'verificationCaseDefinition': !(0, runtime_1.exists)(json, 'verificationCaseDefinition') ? undefined : json['verificationCaseDefinition'],
        'verifiedRequirement': !(0, runtime_1.exists)(json, 'verifiedRequirement') ? undefined : json['verifiedRequirement'],
    };
}
exports.VerificationCaseUsageRequestFromJSONTyped = VerificationCaseUsageRequestFromJSONTyped;
function VerificationCaseUsageRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.VerificationCaseUsageRequestToJSON = VerificationCaseUsageRequestToJSON;
