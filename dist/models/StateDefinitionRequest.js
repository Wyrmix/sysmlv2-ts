...
exports.StateDefinitionRequestToJSON = exports.StateDefinitionRequestFromJSONTyped = exports.StateDefinitionRequestFromJSON = exports.instanceOfStateDefinitionRequest = void 0;
const runtime_1 = require("../runtime");
/**
 * Check if a given object implements the StateDefinitionRequest interface.
 */
function instanceOfStateDefinitionRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfStateDefinitionRequest = instanceOfStateDefinitionRequest;
function StateDefinitionRequestFromJSON(json) {
    return StateDefinitionRequestFromJSONTyped(json, false);
}
exports.StateDefinitionRequestFromJSON = StateDefinitionRequestFromJSON;
function StateDefinitionRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.StateDefinitionRequestFromJSONTyped = StateDefinitionRequestFromJSONTyped;
function StateDefinitionRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.StateDefinitionRequestToJSON = StateDefinitionRequestToJSON;
