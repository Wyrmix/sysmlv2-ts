...
exports.DifferencingToJSON = exports.DifferencingFromJSONTyped = exports.DifferencingFromJSON = exports.instanceOfDifferencing = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the Differencing interface.
 */
function instanceOfDifferencing(value) {
    let isInstance = true;
...
exports.instanceOfDifferencing = instanceOfDifferencing;
function DifferencingFromJSON(json) {
    return DifferencingFromJSONTyped(json, false);
}
exports.DifferencingFromJSON = DifferencingFromJSON;
function DifferencingFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'differencingType': (0, Identified_1.IdentifiedFromJSON)(json['differencingType']),
        ...
        'typeDifferenced': (0, Identified_1.IdentifiedFromJSON)(json['typeDifferenced']),
    };
}
exports.DifferencingFromJSONTyped = DifferencingFromJSONTyped;
function DifferencingToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.DifferencingToJSON = DifferencingToJSON;
