...
exports.EnumerationDefinitionRequestToJSON = exports.EnumerationDefinitionRequestFromJSONTyped = exports.EnumerationDefinitionRequestFromJSON = exports.instanceOfEnumerationDefinitionRequest = void 0;
const runtime_1 = require("../runtime");
/**
 * Check if a given object implements the EnumerationDefinitionRequest interface.
 */
function instanceOfEnumerationDefinitionRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfEnumerationDefinitionRequest = instanceOfEnumerationDefinitionRequest;
function EnumerationDefinitionRequestFromJSON(json) {
    return EnumerationDefinitionRequestFromJSONTyped(json, false);
}
exports.EnumerationDefinitionRequestFromJSON = EnumerationDefinitionRequestFromJSON;
function EnumerationDefinitionRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'enumeratedValue': !(0, runtime_1.exists)(json, 'enumeratedValue') ? undefined : json['enumeratedValue'],
...
exports.EnumerationDefinitionRequestFromJSONTyped = EnumerationDefinitionRequestFromJSONTyped;
function EnumerationDefinitionRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.EnumerationDefinitionRequestToJSON = EnumerationDefinitionRequestToJSON;
