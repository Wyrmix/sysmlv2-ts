...
exports.ViewUsageToJSON = exports.ViewUsageFromJSONTyped = exports.ViewUsageFromJSON = exports.instanceOfViewUsage = void 0;
/**
 * Check if a given object implements the ViewUsage interface.
 */
function instanceOfViewUsage(value) {
    let isInstance = true;
...
exports.instanceOfViewUsage = instanceOfViewUsage;
function ViewUsageFromJSON(json) {
    return ViewUsageFromJSONTyped(json, false);
}
exports.ViewUsageFromJSON = ViewUsageFromJSON;
function ViewUsageFromJSONTyped(json, ignoreDiscriminator) {
...
exports.ViewUsageFromJSONTyped = ViewUsageFromJSONTyped;
function ViewUsageToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ViewUsageToJSON = ViewUsageToJSON;
