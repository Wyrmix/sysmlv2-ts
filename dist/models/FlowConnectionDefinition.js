...
exports.FlowConnectionDefinitionToJSON = exports.FlowConnectionDefinitionFromJSONTyped = exports.FlowConnectionDefinitionFromJSON = exports.instanceOfFlowConnectionDefinition = void 0;
/**
 * Check if a given object implements the FlowConnectionDefinition interface.
 */
function instanceOfFlowConnectionDefinition(value) {
    let isInstance = true;
...
exports.instanceOfFlowConnectionDefinition = instanceOfFlowConnectionDefinition;
function FlowConnectionDefinitionFromJSON(json) {
    return FlowConnectionDefinitionFromJSONTyped(json, false);
}
exports.FlowConnectionDefinitionFromJSON = FlowConnectionDefinitionFromJSON;
function FlowConnectionDefinitionFromJSONTyped(json, ignoreDiscriminator) {
...
exports.FlowConnectionDefinitionFromJSONTyped = FlowConnectionDefinitionFromJSONTyped;
function FlowConnectionDefinitionToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.FlowConnectionDefinitionToJSON = FlowConnectionDefinitionToJSON;
