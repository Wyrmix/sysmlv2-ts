...
exports.ResultExpressionMembershipRequestToJSON = exports.ResultExpressionMembershipRequestFromJSONTyped = exports.ResultExpressionMembershipRequestFromJSON = exports.instanceOfResultExpressionMembershipRequest = void 0;
 ...
 */
function instanceOfResultExpressionMembershipRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfResultExpressionMembershipRequest = instanceOfResultExpressionMembershipRequest;
function ResultExpressionMembershipRequestFromJSON(json) {
    return ResultExpressionMembershipRequestFromJSONTyped(json, false);
}
exports.ResultExpressionMembershipRequestFromJSON = ResultExpressionMembershipRequestFromJSON;
function ResultExpressionMembershipRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'ownedResultExpression': !(0, runtime_1.exists)(json, 'ownedResultExpression') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['ownedResultExpression']),
...
exports.ResultExpressionMembershipRequestFromJSONTyped = ResultExpressionMembershipRequestFromJSONTyped;
function ResultExpressionMembershipRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'ownedResultExpression': (0, Identified_1.IdentifiedToJSON)(value.ownedResultExpression),
        'owner': value.owner,
...
exports.ResultExpressionMembershipRequestToJSON = ResultExpressionMembershipRequestToJSON;
