...
exports.TransitionUsageRequestToJSON = exports.TransitionUsageRequestFromJSONTyped = exports.TransitionUsageRequestFromJSON = exports.instanceOfTransitionUsageRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the TransitionUsageRequest interface.
 */
function instanceOfTransitionUsageRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfTransitionUsageRequest = instanceOfTransitionUsageRequest;
function TransitionUsageRequestFromJSON(json) {
    return TransitionUsageRequestFromJSONTyped(json, false);
}
exports.TransitionUsageRequestFromJSON = TransitionUsageRequestFromJSON;
function TransitionUsageRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'effectAction': !(0, runtime_1.exists)(json, 'effectAction') ? undefined : json['effectAction'],
        ...
        'source': !(0, runtime_1.exists)(json, 'source') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['source']),
        'succession': !(0, runtime_1.exists)(json, 'succession') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['succession']),
        'target': !(0, runtime_1.exists)(json, 'target') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['target']),
        'textualRepresentation': !(0, runtime_1.exists)(json, 'textualRepresentation') ? undefined : json['textualRepresentation'],
        'triggerAction': !(0, runtime_1.exists)(json, 'triggerAction') ? undefined : json['triggerAction'],
...
exports.TransitionUsageRequestFromJSONTyped = TransitionUsageRequestFromJSONTyped;
function TransitionUsageRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'source': (0, Identified_1.IdentifiedToJSON)(value.source),
        'succession': (0, Identified_1.IdentifiedToJSON)(value.succession),
        'target': (0, Identified_1.IdentifiedToJSON)(value.target),
...
exports.TransitionUsageRequestToJSON = TransitionUsageRequestToJSON;
