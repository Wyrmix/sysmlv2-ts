...
exports.RenderingDefinitionRequestToJSON = exports.RenderingDefinitionRequestFromJSONTyped = exports.RenderingDefinitionRequestFromJSON = exports.instanceOfRenderingDefinitionRequest = void 0;
const runtime_1 = require("../runtime");
/**
 * Check if a given object implements the RenderingDefinitionRequest interface.
 */
function instanceOfRenderingDefinitionRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfRenderingDefinitionRequest = instanceOfRenderingDefinitionRequest;
function RenderingDefinitionRequestFromJSON(json) {
    return RenderingDefinitionRequestFromJSONTyped(json, false);
}
exports.RenderingDefinitionRequestFromJSON = RenderingDefinitionRequestFromJSON;
function RenderingDefinitionRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'rendering': !(0, runtime_1.exists)(json, 'rendering') ? undefined : json['rendering'],
...
exports.RenderingDefinitionRequestFromJSONTyped = RenderingDefinitionRequestFromJSONTyped;
function RenderingDefinitionRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.RenderingDefinitionRequestToJSON = RenderingDefinitionRequestToJSON;
