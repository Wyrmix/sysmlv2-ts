...
exports.FramedConcernMembershipRequestToJSON = exports.FramedConcernMembershipRequestFromJSONTyped = exports.FramedConcernMembershipRequestFromJSON = exports.instanceOfFramedConcernMembershipRequest = void 0;
 ...
 */
function instanceOfFramedConcernMembershipRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfFramedConcernMembershipRequest = instanceOfFramedConcernMembershipRequest;
function FramedConcernMembershipRequestFromJSON(json) {
    return FramedConcernMembershipRequestFromJSONTyped(json, false);
}
exports.FramedConcernMembershipRequestFromJSON = FramedConcernMembershipRequestFromJSON;
function FramedConcernMembershipRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'ownedConcern': !(0, runtime_1.exists)(json, 'ownedConcern') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['ownedConcern']),
        ...
        'referencedConcern': !(0, runtime_1.exists)(json, 'referencedConcern') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['referencedConcern']),
...
exports.FramedConcernMembershipRequestFromJSONTyped = FramedConcernMembershipRequestFromJSONTyped;
function FramedConcernMembershipRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'ownedConcern': (0, Identified_1.IdentifiedToJSON)(value.ownedConcern),
        ...
        'referencedConcern': (0, Identified_1.IdentifiedToJSON)(value.referencedConcern),
...
exports.FramedConcernMembershipRequestToJSON = FramedConcernMembershipRequestToJSON;
