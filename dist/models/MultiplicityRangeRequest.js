...
exports.MultiplicityRangeRequestToJSON = exports.MultiplicityRangeRequestFromJSONTyped = exports.MultiplicityRangeRequestFromJSON = exports.instanceOfMultiplicityRangeRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the MultiplicityRangeRequest interface.
 */
function instanceOfMultiplicityRangeRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfMultiplicityRangeRequest = instanceOfMultiplicityRangeRequest;
function MultiplicityRangeRequestFromJSON(json) {
    return MultiplicityRangeRequestFromJSONTyped(json, false);
}
exports.MultiplicityRangeRequestFromJSON = MultiplicityRangeRequestFromJSON;
function MultiplicityRangeRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'bound': !(0, runtime_1.exists)(json, 'bound') ? undefined : json['bound'],
        ...
        'upperBound': !(0, runtime_1.exists)(json, 'upperBound') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['upperBound']),
    };
}
exports.MultiplicityRangeRequestFromJSONTyped = MultiplicityRangeRequestFromJSONTyped;
function MultiplicityRangeRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'upperBound': (0, Identified_1.IdentifiedToJSON)(value.upperBound),
    };
}
exports.MultiplicityRangeRequestToJSON = MultiplicityRangeRequestToJSON;
