...
exports.CollectExpressionToJSON = exports.CollectExpressionFromJSONTyped = exports.CollectExpressionFromJSON = exports.instanceOfCollectExpression = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the CollectExpression interface.
 */
function instanceOfCollectExpression(value) {
    let isInstance = true;
...
exports.instanceOfCollectExpression = instanceOfCollectExpression;
function CollectExpressionFromJSON(json) {
    return CollectExpressionFromJSONTyped(json, false);
}
exports.CollectExpressionFromJSON = CollectExpressionFromJSON;
function CollectExpressionFromJSONTyped(json, ignoreDiscriminator) {
...
exports.CollectExpressionFromJSONTyped = CollectExpressionFromJSONTyped;
function CollectExpressionToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.CollectExpressionToJSON = CollectExpressionToJSON;
