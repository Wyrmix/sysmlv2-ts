...
exports.IncludeUseCaseUsageRequestToJSON = exports.IncludeUseCaseUsageRequestFromJSONTyped = exports.IncludeUseCaseUsageRequestFromJSON = exports.instanceOfIncludeUseCaseUsageRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the IncludeUseCaseUsageRequest interface.
 */
function instanceOfIncludeUseCaseUsageRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfIncludeUseCaseUsageRequest = instanceOfIncludeUseCaseUsageRequest;
function IncludeUseCaseUsageRequestFromJSON(json) {
    return IncludeUseCaseUsageRequestFromJSONTyped(json, false);
}
exports.IncludeUseCaseUsageRequestFromJSON = IncludeUseCaseUsageRequestFromJSON;
function IncludeUseCaseUsageRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'calculationDefinition': !(0, runtime_1.exists)(json, 'calculationDefinition') ? undefined : json['calculationDefinition'],
        'caseDefinition': !(0, runtime_1.exists)(json, 'caseDefinition') ? undefined : json['caseDefinition'],
        ...
        'eventOccurrence': !(0, runtime_1.exists)(json, 'eventOccurrence') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['eventOccurrence']),
        ...
        'includedUseCase': !(0, runtime_1.exists)(json, 'includedUseCase') ? undefined : json['includedUseCase'],
        ...
        'objectiveRequirement': !(0, runtime_1.exists)(json, 'objectiveRequirement') ? undefined : json['objectiveRequirement'],
        ...
        'performedAction': !(0, runtime_1.exists)(json, 'performedAction') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['performedAction']),
        ...
        'useCaseDefinition': !(0, runtime_1.exists)(json, 'useCaseDefinition') ? undefined : json['useCaseDefinition'],
        'useCaseIncluded': !(0, runtime_1.exists)(json, 'useCaseIncluded') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['useCaseIncluded']),
...
exports.IncludeUseCaseUsageRequestFromJSONTyped = IncludeUseCaseUsageRequestFromJSONTyped;
function IncludeUseCaseUsageRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'eventOccurrence': (0, Identified_1.IdentifiedToJSON)(value.eventOccurrence),
        ...
        'performedAction': (0, Identified_1.IdentifiedToJSON)(value.performedAction),
        ...
        'useCaseIncluded': (0, Identified_1.IdentifiedToJSON)(value.useCaseIncluded),
        'variant': value.variant,
        'variantMembership': value.variantMembership,
    };
}
exports.IncludeUseCaseUsageRequestToJSON = IncludeUseCaseUsageRequestToJSON;
