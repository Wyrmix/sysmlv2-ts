...
exports.WhileLoopActionUsageToJSON = exports.WhileLoopActionUsageFromJSONTyped = exports.WhileLoopActionUsageFromJSON = exports.instanceOfWhileLoopActionUsage = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the WhileLoopActionUsage interface.
 */
function instanceOfWhileLoopActionUsage(value) {
    let isInstance = true;
...
exports.instanceOfWhileLoopActionUsage = instanceOfWhileLoopActionUsage;
function WhileLoopActionUsageFromJSON(json) {
    return WhileLoopActionUsageFromJSONTyped(json, false);
}
exports.WhileLoopActionUsageFromJSON = WhileLoopActionUsageFromJSON;
function WhileLoopActionUsageFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'whileArgument': (0, Identified_1.IdentifiedFromJSON)(json['whileArgument']),
    };
}
exports.WhileLoopActionUsageFromJSONTyped = WhileLoopActionUsageFromJSONTyped;
function WhileLoopActionUsageToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.WhileLoopActionUsageToJSON = WhileLoopActionUsageToJSON;
