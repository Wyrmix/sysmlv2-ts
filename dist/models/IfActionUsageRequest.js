...
exports.IfActionUsageRequestToJSON = exports.IfActionUsageRequestFromJSONTyped = exports.IfActionUsageRequestFromJSON = exports.instanceOfIfActionUsageRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the IfActionUsageRequest interface.
 */
function instanceOfIfActionUsageRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfIfActionUsageRequest = instanceOfIfActionUsageRequest;
function IfActionUsageRequestFromJSON(json) {
    return IfActionUsageRequestFromJSONTyped(json, false);
}
exports.IfActionUsageRequestFromJSON = IfActionUsageRequestFromJSON;
function IfActionUsageRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'elseAction': !(0, runtime_1.exists)(json, 'elseAction') ? undefined : json['elseAction'],
        ...
        'ifArgument': !(0, runtime_1.exists)(json, 'ifArgument') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['ifArgument']),
        ...
        'thenAction': !(0, runtime_1.exists)(json, 'thenAction') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['thenAction']),
...
exports.IfActionUsageRequestFromJSONTyped = IfActionUsageRequestFromJSONTyped;
function IfActionUsageRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'ifArgument': (0, Identified_1.IdentifiedToJSON)(value.ifArgument),
        ...
        'thenAction': (0, Identified_1.IdentifiedToJSON)(value.thenAction),
        'type': value.type,
...
exports.IfActionUsageRequestToJSON = IfActionUsageRequestToJSON;
