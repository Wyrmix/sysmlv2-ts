...
exports.SelectExpressionRequestToJSON = exports.SelectExpressionRequestFromJSONTyped = exports.SelectExpressionRequestFromJSON = exports.instanceOfSelectExpressionRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the SelectExpressionRequest interface.
 */
function instanceOfSelectExpressionRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfSelectExpressionRequest = instanceOfSelectExpressionRequest;
function SelectExpressionRequestFromJSON(json) {
    return SelectExpressionRequestFromJSONTyped(json, false);
}
exports.SelectExpressionRequestFromJSON = SelectExpressionRequestFromJSON;
function SelectExpressionRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.SelectExpressionRequestFromJSONTyped = SelectExpressionRequestFromJSONTyped;
function SelectExpressionRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.SelectExpressionRequestToJSON = SelectExpressionRequestToJSON;
