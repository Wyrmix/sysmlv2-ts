...
exports.IntersectingRequestToJSON = exports.IntersectingRequestFromJSONTyped = exports.IntersectingRequestFromJSON = exports.instanceOfIntersectingRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the IntersectingRequest interface.
 */
function instanceOfIntersectingRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfIntersectingRequest = instanceOfIntersectingRequest;
function IntersectingRequestFromJSON(json) {
    return IntersectingRequestFromJSONTyped(json, false);
}
exports.IntersectingRequestFromJSON = IntersectingRequestFromJSON;
function IntersectingRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'intersectingType': !(0, runtime_1.exists)(json, 'intersectingType') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['intersectingType']),
        ...
        'typeIntersected': !(0, runtime_1.exists)(json, 'typeIntersected') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['typeIntersected']),
    };
}
exports.IntersectingRequestFromJSONTyped = IntersectingRequestFromJSONTyped;
function IntersectingRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.IntersectingRequestToJSON = IntersectingRequestToJSON;
