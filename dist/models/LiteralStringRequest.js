...
exports.LiteralStringRequestToJSON = exports.LiteralStringRequestFromJSONTyped = exports.LiteralStringRequestFromJSON = exports.instanceOfLiteralStringRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the LiteralStringRequest interface.
 */
function instanceOfLiteralStringRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfLiteralStringRequest = instanceOfLiteralStringRequest;
function LiteralStringRequestFromJSON(json) {
    return LiteralStringRequestFromJSONTyped(json, false);
}
exports.LiteralStringRequestFromJSON = LiteralStringRequestFromJSON;
function LiteralStringRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.LiteralStringRequestFromJSONTyped = LiteralStringRequestFromJSONTyped;
function LiteralStringRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.LiteralStringRequestToJSON = LiteralStringRequestToJSON;
