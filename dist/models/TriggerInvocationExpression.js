...
exports.TriggerInvocationExpressionToJSON = exports.TriggerInvocationExpressionFromJSONTyped = exports.TriggerInvocationExpressionFromJSON = exports.instanceOfTriggerInvocationExpression = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the TriggerInvocationExpression interface.
 */
function instanceOfTriggerInvocationExpression(value) {
    let isInstance = true;
...
exports.instanceOfTriggerInvocationExpression = instanceOfTriggerInvocationExpression;
function TriggerInvocationExpressionFromJSON(json) {
    return TriggerInvocationExpressionFromJSONTyped(json, false);
}
exports.TriggerInvocationExpressionFromJSON = TriggerInvocationExpressionFromJSON;
function TriggerInvocationExpressionFromJSONTyped(json, ignoreDiscriminator) {
...
exports.TriggerInvocationExpressionFromJSONTyped = TriggerInvocationExpressionFromJSONTyped;
function TriggerInvocationExpressionToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.TriggerInvocationExpressionToJSON = TriggerInvocationExpressionToJSON;
