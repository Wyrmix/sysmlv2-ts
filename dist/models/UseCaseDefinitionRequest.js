...
exports.UseCaseDefinitionRequestToJSON = exports.UseCaseDefinitionRequestFromJSONTyped = exports.UseCaseDefinitionRequestFromJSON = exports.instanceOfUseCaseDefinitionRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the UseCaseDefinitionRequest interface.
 */
function instanceOfUseCaseDefinitionRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfUseCaseDefinitionRequest = instanceOfUseCaseDefinitionRequest;
function UseCaseDefinitionRequestFromJSON(json) {
    return UseCaseDefinitionRequestFromJSONTyped(json, false);
}
exports.UseCaseDefinitionRequestFromJSON = UseCaseDefinitionRequestFromJSON;
function UseCaseDefinitionRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.UseCaseDefinitionRequestFromJSONTyped = UseCaseDefinitionRequestFromJSONTyped;
function UseCaseDefinitionRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.UseCaseDefinitionRequestToJSON = UseCaseDefinitionRequestToJSON;
