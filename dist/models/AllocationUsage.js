...
exports.AllocationUsageToJSON = exports.AllocationUsageFromJSONTyped = exports.AllocationUsageFromJSON = exports.instanceOfAllocationUsage = void 0;
/**
 * Check if a given object implements the AllocationUsage interface.
 */
function instanceOfAllocationUsage(value) {
    let isInstance = true;
...
exports.instanceOfAllocationUsage = instanceOfAllocationUsage;
function AllocationUsageFromJSON(json) {
    return AllocationUsageFromJSONTyped(json, false);
}
exports.AllocationUsageFromJSON = AllocationUsageFromJSON;
function AllocationUsageFromJSONTyped(json, ignoreDiscriminator) {
...
exports.AllocationUsageFromJSONTyped = AllocationUsageFromJSONTyped;
function AllocationUsageToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.AllocationUsageToJSON = AllocationUsageToJSON;
