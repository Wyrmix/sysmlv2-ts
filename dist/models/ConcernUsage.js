...
exports.ConcernUsageToJSON = exports.ConcernUsageFromJSONTyped = exports.ConcernUsageFromJSON = exports.instanceOfConcernUsage = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the ConcernUsage interface.
 */
function instanceOfConcernUsage(value) {
    let isInstance = true;
...
exports.instanceOfConcernUsage = instanceOfConcernUsage;
function ConcernUsageFromJSON(json) {
    return ConcernUsageFromJSONTyped(json, false);
}
exports.ConcernUsageFromJSON = ConcernUsageFromJSON;
function ConcernUsageFromJSONTyped(json, ignoreDiscriminator) {
...
exports.ConcernUsageFromJSONTyped = ConcernUsageFromJSONTyped;
function ConcernUsageToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ConcernUsageToJSON = ConcernUsageToJSON;
