...
exports.ForkNodeToJSON = exports.ForkNodeFromJSONTyped = exports.ForkNodeFromJSON = exports.instanceOfForkNode = void 0;
/**
 * Check if a given object implements the ForkNode interface.
 */
function instanceOfForkNode(value) {
    let isInstance = true;
...
exports.instanceOfForkNode = instanceOfForkNode;
function ForkNodeFromJSON(json) {
    return ForkNodeFromJSONTyped(json, false);
}
exports.ForkNodeFromJSON = ForkNodeFromJSON;
function ForkNodeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.ForkNodeFromJSONTyped = ForkNodeFromJSONTyped;
function ForkNodeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ForkNodeToJSON = ForkNodeToJSON;
