...
exports.ViewUsageRequestToJSON = exports.ViewUsageRequestFromJSONTyped = exports.ViewUsageRequestFromJSON = exports.instanceOfViewUsageRequest = void 0;
const runtime_1 = require("../runtime");
/**
 * Check if a given object implements the ViewUsageRequest interface.
 */
function instanceOfViewUsageRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfViewUsageRequest = instanceOfViewUsageRequest;
function ViewUsageRequestFromJSON(json) {
    return ViewUsageRequestFromJSONTyped(json, false);
}
exports.ViewUsageRequestFromJSON = ViewUsageRequestFromJSON;
function ViewUsageRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'exposedElement': !(0, runtime_1.exists)(json, 'exposedElement') ? undefined : json['exposedElement'],
        ...
        'satisfiedViewpoint': !(0, runtime_1.exists)(json, 'satisfiedViewpoint') ? undefined : json['satisfiedViewpoint'],
        ...
        'viewCondition': !(0, runtime_1.exists)(json, 'viewCondition') ? undefined : json['viewCondition'],
        'viewDefinition': !(0, runtime_1.exists)(json, 'viewDefinition') ? undefined : json['viewDefinition'],
        'viewRendering': !(0, runtime_1.exists)(json, 'viewRendering') ? undefined : json['viewRendering'],
    };
}
exports.ViewUsageRequestFromJSONTyped = ViewUsageRequestFromJSONTyped;
function ViewUsageRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ViewUsageRequestToJSON = ViewUsageRequestToJSON;
