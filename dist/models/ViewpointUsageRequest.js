...
exports.ViewpointUsageRequestToJSON = exports.ViewpointUsageRequestFromJSONTyped = exports.ViewpointUsageRequestFromJSON = exports.instanceOfViewpointUsageRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the ViewpointUsageRequest interface.
 */
function instanceOfViewpointUsageRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfViewpointUsageRequest = instanceOfViewpointUsageRequest;
function ViewpointUsageRequestFromJSON(json) {
    return ViewpointUsageRequestFromJSONTyped(json, false);
}
exports.ViewpointUsageRequestFromJSON = ViewpointUsageRequestFromJSON;
function ViewpointUsageRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'viewpointDefinition': !(0, runtime_1.exists)(json, 'viewpointDefinition') ? undefined : json['viewpointDefinition'],
        'viewpointStakeholder': !(0, runtime_1.exists)(json, 'viewpointStakeholder') ? undefined : json['viewpointStakeholder'],
    };
}
exports.ViewpointUsageRequestFromJSONTyped = ViewpointUsageRequestFromJSONTyped;
function ViewpointUsageRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ViewpointUsageRequestToJSON = ViewpointUsageRequestToJSON;
