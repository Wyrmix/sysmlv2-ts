...
exports.SuccessionAsUsageToJSON = exports.SuccessionAsUsageFromJSONTyped = exports.SuccessionAsUsageFromJSON = exports.instanceOfSuccessionAsUsage = void 0;
/**
 * Check if a given object implements the SuccessionAsUsage interface.
 */
function instanceOfSuccessionAsUsage(value) {
    let isInstance = true;
...
exports.instanceOfSuccessionAsUsage = instanceOfSuccessionAsUsage;
function SuccessionAsUsageFromJSON(json) {
    return SuccessionAsUsageFromJSONTyped(json, false);
}
exports.SuccessionAsUsageFromJSON = SuccessionAsUsageFromJSON;
function SuccessionAsUsageFromJSONTyped(json, ignoreDiscriminator) {
...
exports.SuccessionAsUsageFromJSONTyped = SuccessionAsUsageFromJSONTyped;
function SuccessionAsUsageToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.SuccessionAsUsageToJSON = SuccessionAsUsageToJSON;
