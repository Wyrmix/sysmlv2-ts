...
exports.RenderingUsageToJSON = exports.RenderingUsageFromJSONTyped = exports.RenderingUsageFromJSON = exports.instanceOfRenderingUsage = void 0;
/**
 * Check if a given object implements the RenderingUsage interface.
 */
function instanceOfRenderingUsage(value) {
    let isInstance = true;
...
exports.instanceOfRenderingUsage = instanceOfRenderingUsage;
function RenderingUsageFromJSON(json) {
    return RenderingUsageFromJSONTyped(json, false);
}
exports.RenderingUsageFromJSON = RenderingUsageFromJSON;
function RenderingUsageFromJSONTyped(json, ignoreDiscriminator) {
...
exports.RenderingUsageFromJSONTyped = RenderingUsageFromJSONTyped;
function RenderingUsageToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.RenderingUsageToJSON = RenderingUsageToJSON;
