...
exports.NullExpressionToJSON = exports.NullExpressionFromJSONTyped = exports.NullExpressionFromJSON = exports.instanceOfNullExpression = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the NullExpression interface.
 */
function instanceOfNullExpression(value) {
    let isInstance = true;
...
exports.instanceOfNullExpression = instanceOfNullExpression;
function NullExpressionFromJSON(json) {
    return NullExpressionFromJSONTyped(json, false);
}
exports.NullExpressionFromJSON = NullExpressionFromJSON;
function NullExpressionFromJSONTyped(json, ignoreDiscriminator) {
...
exports.NullExpressionFromJSONTyped = NullExpressionFromJSONTyped;
function NullExpressionToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.NullExpressionToJSON = NullExpressionToJSON;
