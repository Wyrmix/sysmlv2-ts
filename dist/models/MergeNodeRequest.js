...
exports.MergeNodeRequestToJSON = exports.MergeNodeRequestFromJSONTyped = exports.MergeNodeRequestFromJSON = exports.instanceOfMergeNodeRequest = void 0;
const runtime_1 = require("../runtime");
/**
 * Check if a given object implements the MergeNodeRequest interface.
 */
function instanceOfMergeNodeRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfMergeNodeRequest = instanceOfMergeNodeRequest;
function MergeNodeRequestFromJSON(json) {
    return MergeNodeRequestFromJSONTyped(json, false);
}
exports.MergeNodeRequestFromJSON = MergeNodeRequestFromJSON;
function MergeNodeRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.MergeNodeRequestFromJSONTyped = MergeNodeRequestFromJSONTyped;
function MergeNodeRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.MergeNodeRequestToJSON = MergeNodeRequestToJSON;
