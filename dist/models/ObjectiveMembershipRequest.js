...
exports.ObjectiveMembershipRequestToJSON = exports.ObjectiveMembershipRequestFromJSONTyped = exports.ObjectiveMembershipRequestFromJSON = exports.instanceOfObjectiveMembershipRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the ObjectiveMembershipRequest interface.
 */
function instanceOfObjectiveMembershipRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfObjectiveMembershipRequest = instanceOfObjectiveMembershipRequest;
function ObjectiveMembershipRequestFromJSON(json) {
    return ObjectiveMembershipRequestFromJSONTyped(json, false);
}
exports.ObjectiveMembershipRequestFromJSON = ObjectiveMembershipRequestFromJSON;
function ObjectiveMembershipRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'ownedObjectiveRequirement': !(0, runtime_1.exists)(json, 'ownedObjectiveRequirement') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['ownedObjectiveRequirement']),
...
exports.ObjectiveMembershipRequestFromJSONTyped = ObjectiveMembershipRequestFromJSONTyped;
function ObjectiveMembershipRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'ownedObjectiveRequirement': (0, Identified_1.IdentifiedToJSON)(value.ownedObjectiveRequirement),
...
exports.ObjectiveMembershipRequestToJSON = ObjectiveMembershipRequestToJSON;
