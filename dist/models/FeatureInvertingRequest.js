...
exports.FeatureInvertingRequestToJSON = exports.FeatureInvertingRequestFromJSONTyped = exports.FeatureInvertingRequestFromJSON = exports.instanceOfFeatureInvertingRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the FeatureInvertingRequest interface.
 */
function instanceOfFeatureInvertingRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfFeatureInvertingRequest = instanceOfFeatureInvertingRequest;
function FeatureInvertingRequestFromJSON(json) {
    return FeatureInvertingRequestFromJSONTyped(json, false);
}
exports.FeatureInvertingRequestFromJSON = FeatureInvertingRequestFromJSON;
function FeatureInvertingRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'featureInverted': !(0, runtime_1.exists)(json, 'featureInverted') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['featureInverted']),
        'invertingFeature': !(0, runtime_1.exists)(json, 'invertingFeature') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['invertingFeature']),
...
exports.FeatureInvertingRequestFromJSONTyped = FeatureInvertingRequestFromJSONTyped;
function FeatureInvertingRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.FeatureInvertingRequestToJSON = FeatureInvertingRequestToJSON;
