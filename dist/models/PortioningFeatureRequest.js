...
exports.PortioningFeatureRequestToJSON = exports.PortioningFeatureRequestFromJSONTyped = exports.PortioningFeatureRequestFromJSON = exports.instanceOfPortioningFeatureRequest = void 0;
const runtime_1 = require("../runtime");
/**
 * Check if a given object implements the PortioningFeatureRequest interface.
 */
function instanceOfPortioningFeatureRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfPortioningFeatureRequest = instanceOfPortioningFeatureRequest;
function PortioningFeatureRequestFromJSON(json) {
    return PortioningFeatureRequestFromJSONTyped(json, false);
}
exports.PortioningFeatureRequestFromJSON = PortioningFeatureRequestFromJSON;
function PortioningFeatureRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.PortioningFeatureRequestFromJSONTyped = PortioningFeatureRequestFromJSONTyped;
function PortioningFeatureRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.PortioningFeatureRequestToJSON = PortioningFeatureRequestToJSON;
