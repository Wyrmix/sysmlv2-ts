...
exports.DecisionNodeToJSON = exports.DecisionNodeFromJSONTyped = exports.DecisionNodeFromJSON = exports.instanceOfDecisionNode = void 0;
/**
 * Check if a given object implements the DecisionNode interface.
 */
function instanceOfDecisionNode(value) {
    let isInstance = true;
...
exports.instanceOfDecisionNode = instanceOfDecisionNode;
function DecisionNodeFromJSON(json) {
    return DecisionNodeFromJSONTyped(json, false);
}
exports.DecisionNodeFromJSON = DecisionNodeFromJSON;
function DecisionNodeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.DecisionNodeFromJSONTyped = DecisionNodeFromJSONTyped;
function DecisionNodeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.DecisionNodeToJSON = DecisionNodeToJSON;
