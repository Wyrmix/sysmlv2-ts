...
exports.ReturnParameterMembershipToJSON = exports.ReturnParameterMembershipFromJSONTyped = exports.ReturnParameterMembershipFromJSON = exports.instanceOfReturnParameterMembership = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the ReturnParameterMembership interface.
 */
function instanceOfReturnParameterMembership(value) {
    let isInstance = true;
...
exports.instanceOfReturnParameterMembership = instanceOfReturnParameterMembership;
function ReturnParameterMembershipFromJSON(json) {
    return ReturnParameterMembershipFromJSONTyped(json, false);
}
exports.ReturnParameterMembershipFromJSON = ReturnParameterMembershipFromJSON;
function ReturnParameterMembershipFromJSONTyped(json, ignoreDiscriminator) {
...
exports.ReturnParameterMembershipFromJSONTyped = ReturnParameterMembershipFromJSONTyped;
function ReturnParameterMembershipToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ReturnParameterMembershipToJSON = ReturnParameterMembershipToJSON;
