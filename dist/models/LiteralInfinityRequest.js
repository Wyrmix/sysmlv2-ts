...
exports.LiteralInfinityRequestToJSON = exports.LiteralInfinityRequestFromJSONTyped = exports.LiteralInfinityRequestFromJSON = exports.instanceOfLiteralInfinityRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the LiteralInfinityRequest interface.
 */
function instanceOfLiteralInfinityRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfLiteralInfinityRequest = instanceOfLiteralInfinityRequest;
function LiteralInfinityRequestFromJSON(json) {
    return LiteralInfinityRequestFromJSONTyped(json, false);
}
exports.LiteralInfinityRequestFromJSON = LiteralInfinityRequestFromJSON;
function LiteralInfinityRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.LiteralInfinityRequestFromJSONTyped = LiteralInfinityRequestFromJSONTyped;
function LiteralInfinityRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.LiteralInfinityRequestToJSON = LiteralInfinityRequestToJSON;
