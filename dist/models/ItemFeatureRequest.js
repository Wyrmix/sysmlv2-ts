...
exports.ItemFeatureRequestToJSON = exports.ItemFeatureRequestFromJSONTyped = exports.ItemFeatureRequestFromJSON = exports.instanceOfItemFeatureRequest = void 0;
const runtime_1 = require("../runtime");
/**
 * Check if a given object implements the ItemFeatureRequest interface.
 */
function instanceOfItemFeatureRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfItemFeatureRequest = instanceOfItemFeatureRequest;
function ItemFeatureRequestFromJSON(json) {
    return ItemFeatureRequestFromJSONTyped(json, false);
}
exports.ItemFeatureRequestFromJSON = ItemFeatureRequestFromJSON;
function ItemFeatureRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.ItemFeatureRequestFromJSONTyped = ItemFeatureRequestFromJSONTyped;
function ItemFeatureRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ItemFeatureRequestToJSON = ItemFeatureRequestToJSON;
