...
exports.DecisionNodeRequestToJSON = exports.DecisionNodeRequestFromJSONTyped = exports.DecisionNodeRequestFromJSON = exports.instanceOfDecisionNodeRequest = void 0;
const runtime_1 = require("../runtime");
/**
 * Check if a given object implements the DecisionNodeRequest interface.
 */
function instanceOfDecisionNodeRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfDecisionNodeRequest = instanceOfDecisionNodeRequest;
function DecisionNodeRequestFromJSON(json) {
    return DecisionNodeRequestFromJSONTyped(json, false);
}
exports.DecisionNodeRequestFromJSON = DecisionNodeRequestFromJSON;
function DecisionNodeRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.DecisionNodeRequestFromJSONTyped = DecisionNodeRequestFromJSONTyped;
function DecisionNodeRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.DecisionNodeRequestToJSON = DecisionNodeRequestToJSON;
