...
exports.MetadataDefinitionRequestToJSON = exports.MetadataDefinitionRequestFromJSONTyped = exports.MetadataDefinitionRequestFromJSON = exports.instanceOfMetadataDefinitionRequest = void 0;
const runtime_1 = require("../runtime");
/**
 * Check if a given object implements the MetadataDefinitionRequest interface.
 */
function instanceOfMetadataDefinitionRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfMetadataDefinitionRequest = instanceOfMetadataDefinitionRequest;
function MetadataDefinitionRequestFromJSON(json) {
    return MetadataDefinitionRequestFromJSONTyped(json, false);
}
exports.MetadataDefinitionRequestFromJSON = MetadataDefinitionRequestFromJSON;
function MetadataDefinitionRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.MetadataDefinitionRequestFromJSONTyped = MetadataDefinitionRequestFromJSONTyped;
function MetadataDefinitionRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.MetadataDefinitionRequestToJSON = MetadataDefinitionRequestToJSON;
