...
exports.BindingConnectorAsUsageRequestToJSON = exports.BindingConnectorAsUsageRequestFromJSONTyped = exports.BindingConnectorAsUsageRequestFromJSON = exports.instanceOfBindingConnectorAsUsageRequest = void 0;
const runtime_1 = require("../runtime");
/**
 * Check if a given object implements the BindingConnectorAsUsageRequest interface.
 */
function instanceOfBindingConnectorAsUsageRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfBindingConnectorAsUsageRequest = instanceOfBindingConnectorAsUsageRequest;
function BindingConnectorAsUsageRequestFromJSON(json) {
    return BindingConnectorAsUsageRequestFromJSONTyped(json, false);
}
exports.BindingConnectorAsUsageRequestFromJSON = BindingConnectorAsUsageRequestFromJSON;
function BindingConnectorAsUsageRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.BindingConnectorAsUsageRequestFromJSONTyped = BindingConnectorAsUsageRequestFromJSONTyped;
function BindingConnectorAsUsageRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.BindingConnectorAsUsageRequestToJSON = BindingConnectorAsUsageRequestToJSON;
