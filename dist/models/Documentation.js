...
exports.DocumentationToJSON = exports.DocumentationFromJSONTyped = exports.DocumentationFromJSON = exports.instanceOfDocumentation = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the Documentation interface.
 */
function instanceOfDocumentation(value) {
    let isInstance = true;
...
exports.instanceOfDocumentation = instanceOfDocumentation;
function DocumentationFromJSON(json) {
    return DocumentationFromJSONTyped(json, false);
}
exports.DocumentationFromJSON = DocumentationFromJSON;
function DocumentationFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'documentedElement': (0, Identified_1.IdentifiedFromJSON)(json['documentedElement']),
...
exports.DocumentationFromJSONTyped = DocumentationFromJSONTyped;
function DocumentationToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.DocumentationToJSON = DocumentationToJSON;
