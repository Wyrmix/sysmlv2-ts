...
exports.LiteralBooleanToJSON = exports.LiteralBooleanFromJSONTyped = exports.LiteralBooleanFromJSON = exports.instanceOfLiteralBoolean = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the LiteralBoolean interface.
 */
function instanceOfLiteralBoolean(value) {
    let isInstance = true;
...
exports.instanceOfLiteralBoolean = instanceOfLiteralBoolean;
function LiteralBooleanFromJSON(json) {
    return LiteralBooleanFromJSONTyped(json, false);
}
exports.LiteralBooleanFromJSON = LiteralBooleanFromJSON;
function LiteralBooleanFromJSONTyped(json, ignoreDiscriminator) {
...
exports.LiteralBooleanFromJSONTyped = LiteralBooleanFromJSONTyped;
function LiteralBooleanToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.LiteralBooleanToJSON = LiteralBooleanToJSON;
