...
exports.StakeholderMembershipToJSON = exports.StakeholderMembershipFromJSONTyped = exports.StakeholderMembershipFromJSON = exports.instanceOfStakeholderMembership = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the StakeholderMembership interface.
 */
function instanceOfStakeholderMembership(value) {
    let isInstance = true;
...
exports.instanceOfStakeholderMembership = instanceOfStakeholderMembership;
function StakeholderMembershipFromJSON(json) {
    return StakeholderMembershipFromJSONTyped(json, false);
}
exports.StakeholderMembershipFromJSON = StakeholderMembershipFromJSON;
function StakeholderMembershipFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'ownedMemberParameter': (0, Identified_1.IdentifiedFromJSON)(json['ownedMemberParameter']),
        ...
        'ownedStakeholderParameter': (0, Identified_1.IdentifiedFromJSON)(json['ownedStakeholderParameter']),
        'owner': json['owner'],
...
exports.StakeholderMembershipFromJSONTyped = StakeholderMembershipFromJSONTyped;
function StakeholderMembershipToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.StakeholderMembershipToJSON = StakeholderMembershipToJSON;
