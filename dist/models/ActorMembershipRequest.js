...
exports.ActorMembershipRequestToJSON = exports.ActorMembershipRequestFromJSONTyped = exports.ActorMembershipRequestFromJSON = exports.instanceOfActorMembershipRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the ActorMembershipRequest interface.
 */
function instanceOfActorMembershipRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfActorMembershipRequest = instanceOfActorMembershipRequest;
function ActorMembershipRequestFromJSON(json) {
    return ActorMembershipRequestFromJSONTyped(json, false);
}
exports.ActorMembershipRequestFromJSON = ActorMembershipRequestFromJSON;
function ActorMembershipRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'ownedActorParameter': !(0, runtime_1.exists)(json, 'ownedActorParameter') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['ownedActorParameter']),
...
exports.ActorMembershipRequestFromJSONTyped = ActorMembershipRequestFromJSONTyped;
function ActorMembershipRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'name': value.name,
        'ownedActorParameter': (0, Identified_1.IdentifiedToJSON)(value.ownedActorParameter),
...
exports.ActorMembershipRequestToJSON = ActorMembershipRequestToJSON;
