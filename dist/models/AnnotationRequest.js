...
exports.AnnotationRequestToJSON = exports.AnnotationRequestFromJSONTyped = exports.AnnotationRequestFromJSON = exports.instanceOfAnnotationRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the AnnotationRequest interface.
 */
function instanceOfAnnotationRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfAnnotationRequest = instanceOfAnnotationRequest;
function AnnotationRequestFromJSON(json) {
    return AnnotationRequestFromJSONTyped(json, false);
}
exports.AnnotationRequestFromJSON = AnnotationRequestFromJSON;
function AnnotationRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'annotatedElement': !(0, runtime_1.exists)(json, 'annotatedElement') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['annotatedElement']),
        'annotatingElement': !(0, runtime_1.exists)(json, 'annotatingElement') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['annotatingElement']),
        ...
        'owningAnnotatedElement': !(0, runtime_1.exists)(json, 'owningAnnotatedElement') ? undefined : json['owningAnnotatedElement'],
...
exports.AnnotationRequestFromJSONTyped = AnnotationRequestFromJSONTyped;
function AnnotationRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'annotatedElement': (0, Identified_1.IdentifiedToJSON)(value.annotatedElement),
        'annotatingElement': (0, Identified_1.IdentifiedToJSON)(value.annotatingElement),
...
exports.AnnotationRequestToJSON = AnnotationRequestToJSON;
