...
exports.DisjoiningRequestToJSON = exports.DisjoiningRequestFromJSONTyped = exports.DisjoiningRequestFromJSON = exports.instanceOfDisjoiningRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the DisjoiningRequest interface.
 */
function instanceOfDisjoiningRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfDisjoiningRequest = instanceOfDisjoiningRequest;
function DisjoiningRequestFromJSON(json) {
    return DisjoiningRequestFromJSONTyped(json, false);
}
exports.DisjoiningRequestFromJSON = DisjoiningRequestFromJSON;
function DisjoiningRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'disjoiningType': !(0, runtime_1.exists)(json, 'disjoiningType') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['disjoiningType']),
        ...
        'typeDisjoined': !(0, runtime_1.exists)(json, 'typeDisjoined') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['typeDisjoined']),
    };
}
exports.DisjoiningRequestFromJSONTyped = DisjoiningRequestFromJSONTyped;
function DisjoiningRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.DisjoiningRequestToJSON = DisjoiningRequestToJSON;
