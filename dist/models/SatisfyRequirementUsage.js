...
exports.SatisfyRequirementUsageToJSON = exports.SatisfyRequirementUsageFromJSONTyped = exports.SatisfyRequirementUsageFromJSON = exports.instanceOfSatisfyRequirementUsage = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the SatisfyRequirementUsage interface.
 */
function instanceOfSatisfyRequirementUsage(value) {
    let isInstance = true;
...
exports.instanceOfSatisfyRequirementUsage = instanceOfSatisfyRequirementUsage;
function SatisfyRequirementUsageFromJSON(json) {
    return SatisfyRequirementUsageFromJSONTyped(json, false);
}
exports.SatisfyRequirementUsageFromJSON = SatisfyRequirementUsageFromJSON;
function SatisfyRequirementUsageFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'assertedConstraint': (0, Identified_1.IdentifiedFromJSON)(json['assertedConstraint']),
        ...
        'satisfiedRequirement': (0, Identified_1.IdentifiedFromJSON)(json['satisfiedRequirement']),
        'satisfyingFeature': (0, Identified_1.IdentifiedFromJSON)(json['satisfyingFeature']),
...
exports.SatisfyRequirementUsageFromJSONTyped = SatisfyRequirementUsageFromJSONTyped;
function SatisfyRequirementUsageToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.SatisfyRequirementUsageToJSON = SatisfyRequirementUsageToJSON;
