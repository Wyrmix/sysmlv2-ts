...
exports.LiteralIntegerRequestToJSON = exports.LiteralIntegerRequestFromJSONTyped = exports.LiteralIntegerRequestFromJSON = exports.instanceOfLiteralIntegerRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the LiteralIntegerRequest interface.
 */
function instanceOfLiteralIntegerRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfLiteralIntegerRequest = instanceOfLiteralIntegerRequest;
function LiteralIntegerRequestFromJSON(json) {
    return LiteralIntegerRequestFromJSONTyped(json, false);
}
exports.LiteralIntegerRequestFromJSON = LiteralIntegerRequestFromJSON;
function LiteralIntegerRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.LiteralIntegerRequestFromJSONTyped = LiteralIntegerRequestFromJSONTyped;
function LiteralIntegerRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.LiteralIntegerRequestToJSON = LiteralIntegerRequestToJSON;
