...
exports.ExhibitStateUsageRequestToJSON = exports.ExhibitStateUsageRequestFromJSONTyped = exports.ExhibitStateUsageRequestFromJSON = exports.instanceOfExhibitStateUsageRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the ExhibitStateUsageRequest interface.
 */
function instanceOfExhibitStateUsageRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfExhibitStateUsageRequest = instanceOfExhibitStateUsageRequest;
function ExhibitStateUsageRequestFromJSON(json) {
    return ExhibitStateUsageRequestFromJSONTyped(json, false);
}
exports.ExhibitStateUsageRequestFromJSON = ExhibitStateUsageRequestFromJSON;
function ExhibitStateUsageRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'doAction': !(0, runtime_1.exists)(json, 'doAction') ? undefined : json['doAction'],
        ...
        'entryAction': !(0, runtime_1.exists)(json, 'entryAction') ? undefined : json['entryAction'],
        'eventOccurrence': !(0, runtime_1.exists)(json, 'eventOccurrence') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['eventOccurrence']),
        'exhibitedState': !(0, runtime_1.exists)(json, 'exhibitedState') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['exhibitedState']),
        'exitAction': !(0, runtime_1.exists)(json, 'exitAction') ? undefined : json['exitAction'],
        ...
        'isParallel': !(0, runtime_1.exists)(json, 'isParallel') ? undefined : json['isParallel'],
        ...
        'stateDefinition': !(0, runtime_1.exists)(json, 'stateDefinition') ? undefined : json['stateDefinition'],
...
exports.ExhibitStateUsageRequestFromJSONTyped = ExhibitStateUsageRequestFromJSONTyped;
function ExhibitStateUsageRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'exhibitedState': (0, Identified_1.IdentifiedToJSON)(value.exhibitedState),
...
exports.ExhibitStateUsageRequestToJSON = ExhibitStateUsageRequestToJSON;
