...
exports.ConjugatedPortTypingRequestToJSON = exports.ConjugatedPortTypingRequestFromJSONTyped = exports.ConjugatedPortTypingRequestFromJSON = exports.instanceOfConjugatedPortTypingRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the ConjugatedPortTypingRequest interface.
 */
function instanceOfConjugatedPortTypingRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfConjugatedPortTypingRequest = instanceOfConjugatedPortTypingRequest;
function ConjugatedPortTypingRequestFromJSON(json) {
    return ConjugatedPortTypingRequestFromJSONTyped(json, false);
}
exports.ConjugatedPortTypingRequestFromJSON = ConjugatedPortTypingRequestFromJSON;
function ConjugatedPortTypingRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'owningFeature': !(0, runtime_1.exists)(json, 'owningFeature') ? undefined : json['owningFeature'],
        ...
        'portDefinition': !(0, runtime_1.exists)(json, 'portDefinition') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['portDefinition']),
        ...
        'typedFeature': !(0, runtime_1.exists)(json, 'typedFeature') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['typedFeature']),
    };
}
exports.ConjugatedPortTypingRequestFromJSONTyped = ConjugatedPortTypingRequestFromJSONTyped;
function ConjugatedPortTypingRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ConjugatedPortTypingRequestToJSON = ConjugatedPortTypingRequestToJSON;
