...
exports.EndFeatureMembershipRequestToJSON = exports.EndFeatureMembershipRequestFromJSONTyped = exports.EndFeatureMembershipRequestFromJSON = exports.instanceOfEndFeatureMembershipRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the EndFeatureMembershipRequest interface.
 */
function instanceOfEndFeatureMembershipRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfEndFeatureMembershipRequest = instanceOfEndFeatureMembershipRequest;
function EndFeatureMembershipRequestFromJSON(json) {
    return EndFeatureMembershipRequestFromJSONTyped(json, false);
}
exports.EndFeatureMembershipRequestFromJSON = EndFeatureMembershipRequestFromJSON;
function EndFeatureMembershipRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.EndFeatureMembershipRequestFromJSONTyped = EndFeatureMembershipRequestFromJSONTyped;
function EndFeatureMembershipRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.EndFeatureMembershipRequestToJSON = EndFeatureMembershipRequestToJSON;
