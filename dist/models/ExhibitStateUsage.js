...
exports.ExhibitStateUsageToJSON = exports.ExhibitStateUsageFromJSONTyped = exports.ExhibitStateUsageFromJSON = exports.instanceOfExhibitStateUsage = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the ExhibitStateUsage interface.
 */
function instanceOfExhibitStateUsage(value) {
    let isInstance = true;
...
exports.instanceOfExhibitStateUsage = instanceOfExhibitStateUsage;
function ExhibitStateUsageFromJSON(json) {
    return ExhibitStateUsageFromJSONTyped(json, false);
}
exports.ExhibitStateUsageFromJSON = ExhibitStateUsageFromJSON;
function ExhibitStateUsageFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'eventOccurrence': (0, Identified_1.IdentifiedFromJSON)(json['eventOccurrence']),
        'exhibitedState': (0, Identified_1.IdentifiedFromJSON)(json['exhibitedState']),
        ...
        'performedAction': (0, Identified_1.IdentifiedFromJSON)(json['performedAction']),
...
exports.ExhibitStateUsageFromJSONTyped = ExhibitStateUsageFromJSONTyped;
function ExhibitStateUsageToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ExhibitStateUsageToJSON = ExhibitStateUsageToJSON;
