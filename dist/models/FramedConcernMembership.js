...
exports.FramedConcernMembershipToJSON = exports.FramedConcernMembershipFromJSONTyped = exports.FramedConcernMembershipFromJSON = exports.instanceOfFramedConcernMembership = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the FramedConcernMembership interface.
 */
function instanceOfFramedConcernMembership(value) {
    let isInstance = true;
...
exports.instanceOfFramedConcernMembership = instanceOfFramedConcernMembership;
function FramedConcernMembershipFromJSON(json) {
    return FramedConcernMembershipFromJSONTyped(json, false);
}
exports.FramedConcernMembershipFromJSON = FramedConcernMembershipFromJSON;
function FramedConcernMembershipFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'ownedConcern': (0, Identified_1.IdentifiedFromJSON)(json['ownedConcern']),
        ...
        'referencedConcern': (0, Identified_1.IdentifiedFromJSON)(json['referencedConcern']),
...
exports.FramedConcernMembershipFromJSONTyped = FramedConcernMembershipFromJSONTyped;
function FramedConcernMembershipToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.FramedConcernMembershipToJSON = FramedConcernMembershipToJSON;
