...
exports.ItemFeatureToJSON = exports.ItemFeatureFromJSONTyped = exports.ItemFeatureFromJSON = exports.instanceOfItemFeature = void 0;
/**
 * Check if a given object implements the ItemFeature interface.
 */
function instanceOfItemFeature(value) {
    let isInstance = true;
...
exports.instanceOfItemFeature = instanceOfItemFeature;
function ItemFeatureFromJSON(json) {
    return ItemFeatureFromJSONTyped(json, false);
}
exports.ItemFeatureFromJSON = ItemFeatureFromJSON;
function ItemFeatureFromJSONTyped(json, ignoreDiscriminator) {
...
exports.ItemFeatureFromJSONTyped = ItemFeatureFromJSONTyped;
function ItemFeatureToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ItemFeatureToJSON = ItemFeatureToJSON;
