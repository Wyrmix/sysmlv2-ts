...
exports.NamespaceExposeToJSON = exports.NamespaceExposeFromJSONTyped = exports.NamespaceExposeFromJSON = exports.instanceOfNamespaceExpose = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the NamespaceExpose interface.
 */
function instanceOfNamespaceExpose(value) {
    let isInstance = true;
...
exports.instanceOfNamespaceExpose = instanceOfNamespaceExpose;
function NamespaceExposeFromJSON(json) {
    return NamespaceExposeFromJSONTyped(json, false);
}
exports.NamespaceExposeFromJSON = NamespaceExposeFromJSON;
function NamespaceExposeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'importOwningNamespace': (0, Identified_1.IdentifiedFromJSON)(json['importOwningNamespace']),
        'importedElement': (0, Identified_1.IdentifiedFromJSON)(json['importedElement']),
        'importedNamespace': (0, Identified_1.IdentifiedFromJSON)(json['importedNamespace']),
...
exports.NamespaceExposeFromJSONTyped = NamespaceExposeFromJSONTyped;
function NamespaceExposeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.NamespaceExposeToJSON = NamespaceExposeToJSON;
