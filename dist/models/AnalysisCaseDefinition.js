...
exports.AnalysisCaseDefinitionToJSON = exports.AnalysisCaseDefinitionFromJSONTyped = exports.AnalysisCaseDefinitionFromJSON = exports.instanceOfAnalysisCaseDefinition = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the AnalysisCaseDefinition interface.
 */
function instanceOfAnalysisCaseDefinition(value) {
    let isInstance = true;
...
exports.instanceOfAnalysisCaseDefinition = instanceOfAnalysisCaseDefinition;
function AnalysisCaseDefinitionFromJSON(json) {
    return AnalysisCaseDefinitionFromJSONTyped(json, false);
}
exports.AnalysisCaseDefinitionFromJSON = AnalysisCaseDefinitionFromJSON;
function AnalysisCaseDefinitionFromJSONTyped(json, ignoreDiscriminator) {
...
exports.AnalysisCaseDefinitionFromJSONTyped = AnalysisCaseDefinitionFromJSONTyped;
function AnalysisCaseDefinitionToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.AnalysisCaseDefinitionToJSON = AnalysisCaseDefinitionToJSON;
