...
exports.ConcernUsageRequestToJSON = exports.ConcernUsageRequestFromJSONTyped = exports.ConcernUsageRequestFromJSON = exports.instanceOfConcernUsageRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the ConcernUsageRequest interface.
 */
function instanceOfConcernUsageRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfConcernUsageRequest = instanceOfConcernUsageRequest;
function ConcernUsageRequestFromJSON(json) {
    return ConcernUsageRequestFromJSONTyped(json, false);
}
exports.ConcernUsageRequestFromJSON = ConcernUsageRequestFromJSON;
function ConcernUsageRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'concernDefinition': !(0, runtime_1.exists)(json, 'concernDefinition') ? undefined : json['concernDefinition'],
...
exports.ConcernUsageRequestFromJSONTyped = ConcernUsageRequestFromJSONTyped;
function ConcernUsageRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ConcernUsageRequestToJSON = ConcernUsageRequestToJSON;
