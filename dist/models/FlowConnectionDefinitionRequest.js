...
exports.FlowConnectionDefinitionRequestToJSON = exports.FlowConnectionDefinitionRequestFromJSONTyped = exports.FlowConnectionDefinitionRequestFromJSON = exports.instanceOfFlowConnectionDefinitionRequest = void 0;
const runtime_1 = require("../runtime");
/**
 * Check if a given object implements the FlowConnectionDefinitionRequest interface.
 */
function instanceOfFlowConnectionDefinitionRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfFlowConnectionDefinitionRequest = instanceOfFlowConnectionDefinitionRequest;
function FlowConnectionDefinitionRequestFromJSON(json) {
    return FlowConnectionDefinitionRequestFromJSONTyped(json, false);
}
exports.FlowConnectionDefinitionRequestFromJSON = FlowConnectionDefinitionRequestFromJSON;
function FlowConnectionDefinitionRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.FlowConnectionDefinitionRequestFromJSONTyped = FlowConnectionDefinitionRequestFromJSONTyped;
function FlowConnectionDefinitionRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.FlowConnectionDefinitionRequestToJSON = FlowConnectionDefinitionRequestToJSON;
