...
exports.ReferenceUsageToJSON = exports.ReferenceUsageFromJSONTyped = exports.ReferenceUsageFromJSON = exports.instanceOfReferenceUsage = void 0;
/**
 * Check if a given object implements the ReferenceUsage interface.
 */
function instanceOfReferenceUsage(value) {
    let isInstance = true;
...
exports.instanceOfReferenceUsage = instanceOfReferenceUsage;
function ReferenceUsageFromJSON(json) {
    return ReferenceUsageFromJSONTyped(json, false);
}
exports.ReferenceUsageFromJSON = ReferenceUsageFromJSON;
function ReferenceUsageFromJSONTyped(json, ignoreDiscriminator) {
...
exports.ReferenceUsageFromJSONTyped = ReferenceUsageFromJSONTyped;
function ReferenceUsageToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ReferenceUsageToJSON = ReferenceUsageToJSON;
