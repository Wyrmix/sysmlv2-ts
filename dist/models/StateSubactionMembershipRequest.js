...
exports.StateSubactionMembershipRequestToJSON = exports.StateSubactionMembershipRequestFromJSONTyped = exports.StateSubactionMembershipRequestFromJSON = exports.instanceOfStateSubactionMembershipRequest = void 0;
 ...
 */
function instanceOfStateSubactionMembershipRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfStateSubactionMembershipRequest = instanceOfStateSubactionMembershipRequest;
function StateSubactionMembershipRequestFromJSON(json) {
    return StateSubactionMembershipRequestFromJSONTyped(json, false);
}
exports.StateSubactionMembershipRequestFromJSON = StateSubactionMembershipRequestFromJSON;
function StateSubactionMembershipRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'atType': json['@type'],
        'action': !(0, runtime_1.exists)(json, 'action') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['action']),
...
exports.StateSubactionMembershipRequestFromJSONTyped = StateSubactionMembershipRequestFromJSONTyped;
function StateSubactionMembershipRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.StateSubactionMembershipRequestToJSON = StateSubactionMembershipRequestToJSON;
