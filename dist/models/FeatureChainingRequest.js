...
exports.FeatureChainingRequestToJSON = exports.FeatureChainingRequestFromJSONTyped = exports.FeatureChainingRequestFromJSON = exports.instanceOfFeatureChainingRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the FeatureChainingRequest interface.
 */
function instanceOfFeatureChainingRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfFeatureChainingRequest = instanceOfFeatureChainingRequest;
function FeatureChainingRequestFromJSON(json) {
    return FeatureChainingRequestFromJSONTyped(json, false);
}
exports.FeatureChainingRequestFromJSON = FeatureChainingRequestFromJSON;
function FeatureChainingRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'chainingFeature': !(0, runtime_1.exists)(json, 'chainingFeature') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['chainingFeature']),
        ...
        'featureChained': !(0, runtime_1.exists)(json, 'featureChained') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['featureChained']),
...
exports.FeatureChainingRequestFromJSONTyped = FeatureChainingRequestFromJSONTyped;
function FeatureChainingRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'chainingFeature': (0, Identified_1.IdentifiedToJSON)(value.chainingFeature),
        'declaredName': value.declaredName,
        'declaredShortName': value.declaredShortName,
        'documentation': value.documentation,
        'elementId': value.elementId,
        'featureChained': (0, Identified_1.IdentifiedToJSON)(value.featureChained),
...
exports.FeatureChainingRequestToJSON = FeatureChainingRequestToJSON;
