...
exports.AcceptActionUsageRequestToJSON = exports.AcceptActionUsageRequestFromJSONTyped = exports.AcceptActionUsageRequestFromJSON = exports.instanceOfAcceptActionUsageRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the AcceptActionUsageRequest interface.
 */
function instanceOfAcceptActionUsageRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfAcceptActionUsageRequest = instanceOfAcceptActionUsageRequest;
function AcceptActionUsageRequestFromJSON(json) {
    return AcceptActionUsageRequestFromJSONTyped(json, false);
}
exports.AcceptActionUsageRequestFromJSON = AcceptActionUsageRequestFromJSON;
function AcceptActionUsageRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'payloadArgument': !(0, runtime_1.exists)(json, 'payloadArgument') ? undefined : json['payloadArgument'],
        'payloadParameter': !(0, runtime_1.exists)(json, 'payloadParameter') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['payloadParameter']),
        ...
        'receiverArgument': !(0, runtime_1.exists)(json, 'receiverArgument') ? undefined : json['receiverArgument'],
...
exports.AcceptActionUsageRequestFromJSONTyped = AcceptActionUsageRequestFromJSONTyped;
function AcceptActionUsageRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'payloadParameter': (0, Identified_1.IdentifiedToJSON)(value.payloadParameter),
...
exports.AcceptActionUsageRequestToJSON = AcceptActionUsageRequestToJSON;
