...
exports.ViewDefinitionToJSON = exports.ViewDefinitionFromJSONTyped = exports.ViewDefinitionFromJSON = exports.instanceOfViewDefinition = void 0;
/**
 * Check if a given object implements the ViewDefinition interface.
 */
function instanceOfViewDefinition(value) {
    let isInstance = true;
...
exports.instanceOfViewDefinition = instanceOfViewDefinition;
function ViewDefinitionFromJSON(json) {
    return ViewDefinitionFromJSONTyped(json, false);
}
exports.ViewDefinitionFromJSON = ViewDefinitionFromJSON;
function ViewDefinitionFromJSONTyped(json, ignoreDiscriminator) {
...
exports.ViewDefinitionFromJSONTyped = ViewDefinitionFromJSONTyped;
function ViewDefinitionToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ViewDefinitionToJSON = ViewDefinitionToJSON;
