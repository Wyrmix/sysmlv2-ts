...
exports.IfActionUsageToJSON = exports.IfActionUsageFromJSONTyped = exports.IfActionUsageFromJSON = exports.instanceOfIfActionUsage = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the IfActionUsage interface.
 */
function instanceOfIfActionUsage(value) {
    let isInstance = true;
...
exports.instanceOfIfActionUsage = instanceOfIfActionUsage;
function IfActionUsageFromJSON(json) {
    return IfActionUsageFromJSONTyped(json, false);
}
exports.IfActionUsageFromJSON = IfActionUsageFromJSON;
function IfActionUsageFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'ifArgument': (0, Identified_1.IdentifiedFromJSON)(json['ifArgument']),
        ...
        'thenAction': (0, Identified_1.IdentifiedFromJSON)(json['thenAction']),
        'type': json['type'],
...
exports.IfActionUsageFromJSONTyped = IfActionUsageFromJSONTyped;
function IfActionUsageToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.IfActionUsageToJSON = IfActionUsageToJSON;
