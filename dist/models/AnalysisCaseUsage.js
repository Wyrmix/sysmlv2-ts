...
exports.AnalysisCaseUsageToJSON = exports.AnalysisCaseUsageFromJSONTyped = exports.AnalysisCaseUsageFromJSON = exports.instanceOfAnalysisCaseUsage = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the AnalysisCaseUsage interface.
 */
function instanceOfAnalysisCaseUsage(value) {
    let isInstance = true;
...
exports.instanceOfAnalysisCaseUsage = instanceOfAnalysisCaseUsage;
function AnalysisCaseUsageFromJSON(json) {
    return AnalysisCaseUsageFromJSONTyped(json, false);
}
exports.AnalysisCaseUsageFromJSON = AnalysisCaseUsageFromJSON;
function AnalysisCaseUsageFromJSONTyped(json, ignoreDiscriminator) {
...
exports.AnalysisCaseUsageFromJSONTyped = AnalysisCaseUsageFromJSONTyped;
function AnalysisCaseUsageToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.AnalysisCaseUsageToJSON = AnalysisCaseUsageToJSON;
