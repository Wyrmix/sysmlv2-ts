...
exports.PortUsageRequestToJSON = exports.PortUsageRequestFromJSONTyped = exports.PortUsageRequestFromJSON = exports.instanceOfPortUsageRequest = void 0;
const runtime_1 = require("../runtime");
/**
 * Check if a given object implements the PortUsageRequest interface.
 */
function instanceOfPortUsageRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfPortUsageRequest = instanceOfPortUsageRequest;
function PortUsageRequestFromJSON(json) {
    return PortUsageRequestFromJSONTyped(json, false);
}
exports.PortUsageRequestFromJSON = PortUsageRequestFromJSON;
function PortUsageRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'portDefinition': !(0, runtime_1.exists)(json, 'portDefinition') ? undefined : json['portDefinition'],
...
exports.PortUsageRequestFromJSONTyped = PortUsageRequestFromJSONTyped;
function PortUsageRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.PortUsageRequestToJSON = PortUsageRequestToJSON;
