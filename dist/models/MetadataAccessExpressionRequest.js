...
exports.MetadataAccessExpressionRequestToJSON = exports.MetadataAccessExpressionRequestFromJSONTyped = exports.MetadataAccessExpressionRequestFromJSON = exports.instanceOfMetadataAccessExpressionRequest = void 0;
 ...
 */
function instanceOfMetadataAccessExpressionRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfMetadataAccessExpressionRequest = instanceOfMetadataAccessExpressionRequest;
function MetadataAccessExpressionRequestFromJSON(json) {
    return MetadataAccessExpressionRequestFromJSONTyped(json, false);
}
exports.MetadataAccessExpressionRequestFromJSON = MetadataAccessExpressionRequestFromJSON;
function MetadataAccessExpressionRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'referencedElement': !(0, runtime_1.exists)(json, 'referencedElement') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['referencedElement']),
...
exports.MetadataAccessExpressionRequestFromJSONTyped = MetadataAccessExpressionRequestFromJSONTyped;
function MetadataAccessExpressionRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'referencedElement': (0, Identified_1.IdentifiedToJSON)(value.referencedElement),
...
exports.MetadataAccessExpressionRequestToJSON = MetadataAccessExpressionRequestToJSON;
