...
exports.ForLoopActionUsageRequestToJSON = exports.ForLoopActionUsageRequestFromJSONTyped = exports.ForLoopActionUsageRequestFromJSON = exports.instanceOfForLoopActionUsageRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the ForLoopActionUsageRequest interface.
 */
function instanceOfForLoopActionUsageRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfForLoopActionUsageRequest = instanceOfForLoopActionUsageRequest;
function ForLoopActionUsageRequestFromJSON(json) {
    return ForLoopActionUsageRequestFromJSONTyped(json, false);
}
exports.ForLoopActionUsageRequestFromJSON = ForLoopActionUsageRequestFromJSON;
function ForLoopActionUsageRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'bodyAction': !(0, runtime_1.exists)(json, 'bodyAction') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['bodyAction']),
        ...
        'loopVariable': !(0, runtime_1.exists)(json, 'loopVariable') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['loopVariable']),
        ...
        'seqArgument': !(0, runtime_1.exists)(json, 'seqArgument') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['seqArgument']),
...
exports.ForLoopActionUsageRequestFromJSONTyped = ForLoopActionUsageRequestFromJSONTyped;
function ForLoopActionUsageRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'bodyAction': (0, Identified_1.IdentifiedToJSON)(value.bodyAction),
        ...
        'loopVariable': (0, Identified_1.IdentifiedToJSON)(value.loopVariable),
        'member': value.member,
        ...
        'seqArgument': (0, Identified_1.IdentifiedToJSON)(value.seqArgument),
...
exports.ForLoopActionUsageRequestToJSON = ForLoopActionUsageRequestToJSON;
