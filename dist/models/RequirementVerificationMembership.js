...
exports.RequirementVerificationMembershipToJSON = exports.RequirementVerificationMembershipFromJSONTyped = exports.RequirementVerificationMembershipFromJSON = exports.instanceOfRequirementVerificationMembership = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the RequirementVerificationMembership interface.
 */
function instanceOfRequirementVerificationMembership(value) {
    let isInstance = true;
...
exports.instanceOfRequirementVerificationMembership = instanceOfRequirementVerificationMembership;
function RequirementVerificationMembershipFromJSON(json) {
    return RequirementVerificationMembershipFromJSONTyped(json, false);
}
exports.RequirementVerificationMembershipFromJSON = RequirementVerificationMembershipFromJSON;
function RequirementVerificationMembershipFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'ownedConstraint': (0, Identified_1.IdentifiedFromJSON)(json['ownedConstraint']),
        ...
        'ownedRequirement': (0, Identified_1.IdentifiedFromJSON)(json['ownedRequirement']),
        'owner': json['owner'],
        ...
        'referencedConstraint': (0, Identified_1.IdentifiedFromJSON)(json['referencedConstraint']),
        ...
        'verifiedRequirement': (0, Identified_1.IdentifiedFromJSON)(json['verifiedRequirement']),
        'visibility': json['visibility'],
    };
}
exports.RequirementVerificationMembershipFromJSONTyped = RequirementVerificationMembershipFromJSONTyped;
function RequirementVerificationMembershipToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.RequirementVerificationMembershipToJSON = RequirementVerificationMembershipToJSON;
