...
exports.SuccessionAsUsageRequestToJSON = exports.SuccessionAsUsageRequestFromJSONTyped = exports.SuccessionAsUsageRequestFromJSON = exports.instanceOfSuccessionAsUsageRequest = void 0;
const runtime_1 = require("../runtime");
/**
 * Check if a given object implements the SuccessionAsUsageRequest interface.
 */
function instanceOfSuccessionAsUsageRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfSuccessionAsUsageRequest = instanceOfSuccessionAsUsageRequest;
function SuccessionAsUsageRequestFromJSON(json) {
    return SuccessionAsUsageRequestFromJSONTyped(json, false);
}
exports.SuccessionAsUsageRequestFromJSON = SuccessionAsUsageRequestFromJSON;
function SuccessionAsUsageRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.SuccessionAsUsageRequestFromJSONTyped = SuccessionAsUsageRequestFromJSONTyped;
function SuccessionAsUsageRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.SuccessionAsUsageRequestToJSON = SuccessionAsUsageRequestToJSON;
