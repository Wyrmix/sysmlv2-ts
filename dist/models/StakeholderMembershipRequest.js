...
exports.StakeholderMembershipRequestToJSON = exports.StakeholderMembershipRequestFromJSONTyped = exports.StakeholderMembershipRequestFromJSON = exports.instanceOfStakeholderMembershipRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the StakeholderMembershipRequest interface.
 */
function instanceOfStakeholderMembershipRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfStakeholderMembershipRequest = instanceOfStakeholderMembershipRequest;
function StakeholderMembershipRequestFromJSON(json) {
    return StakeholderMembershipRequestFromJSONTyped(json, false);
}
exports.StakeholderMembershipRequestFromJSON = StakeholderMembershipRequestFromJSON;
function StakeholderMembershipRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'ownedStakeholderParameter': !(0, runtime_1.exists)(json, 'ownedStakeholderParameter') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['ownedStakeholderParameter']),
...
exports.StakeholderMembershipRequestFromJSONTyped = StakeholderMembershipRequestFromJSONTyped;
function StakeholderMembershipRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'ownedStakeholderParameter': (0, Identified_1.IdentifiedToJSON)(value.ownedStakeholderParameter),
        'owner': value.owner,
...
exports.StakeholderMembershipRequestToJSON = StakeholderMembershipRequestToJSON;
