...
exports.InterfaceDefinitionToJSON = exports.InterfaceDefinitionFromJSONTyped = exports.InterfaceDefinitionFromJSON = exports.instanceOfInterfaceDefinition = void 0;
/**
 * Check if a given object implements the InterfaceDefinition interface.
 */
function instanceOfInterfaceDefinition(value) {
    let isInstance = true;
    isInstance = isInstance && "id" in value;
    isInstance = isInstance && "type" in value;
    isInstance = isInstance && "aliasIds" in value;
    isInstance = isInstance && "associationEnd" in value;
    isInstance = isInstance && "connectionEnd" in value;
    ...
    isInstance = isInstance && "interfaceEnd" in value;
    ...
    isInstance = isInstance && "relatedType" in value;
...
exports.instanceOfInterfaceDefinition = instanceOfInterfaceDefinition;
function InterfaceDefinitionFromJSON(json) {
    return InterfaceDefinitionFromJSONTyped(json, false);
}
exports.InterfaceDefinitionFromJSON = InterfaceDefinitionFromJSON;
function InterfaceDefinitionFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'associationEnd': json['associationEnd'],
        'connectionEnd': json['connectionEnd'],
        ...
        'input': json['input'],
        'interfaceEnd': json['interfaceEnd'],
...
exports.InterfaceDefinitionFromJSONTyped = InterfaceDefinitionFromJSONTyped;
function InterfaceDefinitionToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.InterfaceDefinitionToJSON = InterfaceDefinitionToJSON;
