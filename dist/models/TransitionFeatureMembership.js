...
exports.TransitionFeatureMembershipToJSON = exports.TransitionFeatureMembershipFromJSONTyped = exports.TransitionFeatureMembershipFromJSON = exports.instanceOfTransitionFeatureMembership = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the TransitionFeatureMembership interface.
 */
function instanceOfTransitionFeatureMembership(value) {
    let isInstance = true;
...
exports.instanceOfTransitionFeatureMembership = instanceOfTransitionFeatureMembership;
function TransitionFeatureMembershipFromJSON(json) {
    return TransitionFeatureMembershipFromJSONTyped(json, false);
}
exports.TransitionFeatureMembershipFromJSON = TransitionFeatureMembershipFromJSON;
function TransitionFeatureMembershipFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'transitionFeature': (0, Identified_1.IdentifiedFromJSON)(json['transitionFeature']),
        'type': (0, Identified_1.IdentifiedFromJSON)(json['type']),
        'visibility': json['visibility'],
    };
}
exports.TransitionFeatureMembershipFromJSONTyped = TransitionFeatureMembershipFromJSONTyped;
function TransitionFeatureMembershipToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.TransitionFeatureMembershipToJSON = TransitionFeatureMembershipToJSON;
