...
exports.RedefinitionToJSON = exports.RedefinitionFromJSONTyped = exports.RedefinitionFromJSON = exports.instanceOfRedefinition = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the Redefinition interface.
 */
function instanceOfRedefinition(value) {
    let isInstance = true;
...
exports.instanceOfRedefinition = instanceOfRedefinition;
function RedefinitionFromJSON(json) {
    return RedefinitionFromJSONTyped(json, false);
}
exports.RedefinitionFromJSON = RedefinitionFromJSON;
function RedefinitionFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'redefinedFeature': (0, Identified_1.IdentifiedFromJSON)(json['redefinedFeature']),
        'redefiningFeature': (0, Identified_1.IdentifiedFromJSON)(json['redefiningFeature']),
...
exports.RedefinitionFromJSONTyped = RedefinitionFromJSONTyped;
function RedefinitionToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.RedefinitionToJSON = RedefinitionToJSON;
