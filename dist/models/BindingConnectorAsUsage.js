...
exports.BindingConnectorAsUsageToJSON = exports.BindingConnectorAsUsageFromJSONTyped = exports.BindingConnectorAsUsageFromJSON = exports.instanceOfBindingConnectorAsUsage = void 0;
/**
 * Check if a given object implements the BindingConnectorAsUsage interface.
 */
function instanceOfBindingConnectorAsUsage(value) {
    let isInstance = true;
...
exports.instanceOfBindingConnectorAsUsage = instanceOfBindingConnectorAsUsage;
function BindingConnectorAsUsageFromJSON(json) {
    return BindingConnectorAsUsageFromJSONTyped(json, false);
}
exports.BindingConnectorAsUsageFromJSON = BindingConnectorAsUsageFromJSON;
function BindingConnectorAsUsageFromJSONTyped(json, ignoreDiscriminator) {
...
exports.BindingConnectorAsUsageFromJSONTyped = BindingConnectorAsUsageFromJSONTyped;
function BindingConnectorAsUsageToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.BindingConnectorAsUsageToJSON = BindingConnectorAsUsageToJSON;
