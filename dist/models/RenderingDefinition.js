...
exports.RenderingDefinitionToJSON = exports.RenderingDefinitionFromJSONTyped = exports.RenderingDefinitionFromJSON = exports.instanceOfRenderingDefinition = void 0;
/**
 * Check if a given object implements the RenderingDefinition interface.
 */
function instanceOfRenderingDefinition(value) {
    let isInstance = true;
...
exports.instanceOfRenderingDefinition = instanceOfRenderingDefinition;
function RenderingDefinitionFromJSON(json) {
    return RenderingDefinitionFromJSONTyped(json, false);
}
exports.RenderingDefinitionFromJSON = RenderingDefinitionFromJSON;
function RenderingDefinitionFromJSONTyped(json, ignoreDiscriminator) {
...
exports.RenderingDefinitionFromJSONTyped = RenderingDefinitionFromJSONTyped;
function RenderingDefinitionToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.RenderingDefinitionToJSON = RenderingDefinitionToJSON;
