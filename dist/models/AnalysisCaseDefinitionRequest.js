...
exports.AnalysisCaseDefinitionRequestToJSON = exports.AnalysisCaseDefinitionRequestFromJSONTyped = exports.AnalysisCaseDefinitionRequestFromJSON = exports.instanceOfAnalysisCaseDefinitionRequest = void 0;
 ...
 */
function instanceOfAnalysisCaseDefinitionRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfAnalysisCaseDefinitionRequest = instanceOfAnalysisCaseDefinitionRequest;
function AnalysisCaseDefinitionRequestFromJSON(json) {
    return AnalysisCaseDefinitionRequestFromJSONTyped(json, false);
}
exports.AnalysisCaseDefinitionRequestFromJSON = AnalysisCaseDefinitionRequestFromJSON;
function AnalysisCaseDefinitionRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'calculation': !(0, runtime_1.exists)(json, 'calculation') ? undefined : json['calculation'],
...
exports.AnalysisCaseDefinitionRequestFromJSONTyped = AnalysisCaseDefinitionRequestFromJSONTyped;
function AnalysisCaseDefinitionRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.AnalysisCaseDefinitionRequestToJSON = AnalysisCaseDefinitionRequestToJSON;
