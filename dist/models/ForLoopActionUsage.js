...
exports.ForLoopActionUsageToJSON = exports.ForLoopActionUsageFromJSONTyped = exports.ForLoopActionUsageFromJSON = exports.instanceOfForLoopActionUsage = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the ForLoopActionUsage interface.
 */
function instanceOfForLoopActionUsage(value) {
    let isInstance = true;
...
exports.instanceOfForLoopActionUsage = instanceOfForLoopActionUsage;
function ForLoopActionUsageFromJSON(json) {
    return ForLoopActionUsageFromJSONTyped(json, false);
}
exports.ForLoopActionUsageFromJSON = ForLoopActionUsageFromJSON;
function ForLoopActionUsageFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'bodyAction': (0, Identified_1.IdentifiedFromJSON)(json['bodyAction']),
        ...
        'loopVariable': (0, Identified_1.IdentifiedFromJSON)(json['loopVariable']),
        'member': json['member'],
        ...
        'seqArgument': (0, Identified_1.IdentifiedFromJSON)(json['seqArgument']),
...
exports.ForLoopActionUsageFromJSONTyped = ForLoopActionUsageFromJSONTyped;
function ForLoopActionUsageToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ForLoopActionUsageToJSON = ForLoopActionUsageToJSON;
