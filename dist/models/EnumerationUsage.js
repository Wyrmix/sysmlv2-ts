...
exports.EnumerationUsageToJSON = exports.EnumerationUsageFromJSONTyped = exports.EnumerationUsageFromJSON = exports.instanceOfEnumerationUsage = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the EnumerationUsage interface.
 */
function instanceOfEnumerationUsage(value) {
    let isInstance = true;
...
exports.instanceOfEnumerationUsage = instanceOfEnumerationUsage;
function EnumerationUsageFromJSON(json) {
    return EnumerationUsageFromJSONTyped(json, false);
}
exports.EnumerationUsageFromJSON = EnumerationUsageFromJSON;
function EnumerationUsageFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'enumerationDefinition': (0, Identified_1.IdentifiedFromJSON)(json['enumerationDefinition']),
...
exports.EnumerationUsageFromJSONTyped = EnumerationUsageFromJSONTyped;
function EnumerationUsageToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.EnumerationUsageToJSON = EnumerationUsageToJSON;
