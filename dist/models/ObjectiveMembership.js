...
exports.ObjectiveMembershipToJSON = exports.ObjectiveMembershipFromJSONTyped = exports.ObjectiveMembershipFromJSON = exports.instanceOfObjectiveMembership = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the ObjectiveMembership interface.
 */
function instanceOfObjectiveMembership(value) {
    let isInstance = true;
...
exports.instanceOfObjectiveMembership = instanceOfObjectiveMembership;
function ObjectiveMembershipFromJSON(json) {
    return ObjectiveMembershipFromJSONTyped(json, false);
}
exports.ObjectiveMembershipFromJSON = ObjectiveMembershipFromJSON;
function ObjectiveMembershipFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'ownedObjectiveRequirement': (0, Identified_1.IdentifiedFromJSON)(json['ownedObjectiveRequirement']),
...
exports.ObjectiveMembershipFromJSONTyped = ObjectiveMembershipFromJSONTyped;
function ObjectiveMembershipToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ObjectiveMembershipToJSON = ObjectiveMembershipToJSON;
