...
exports.AllocationDefinitionToJSON = exports.AllocationDefinitionFromJSONTyped = exports.AllocationDefinitionFromJSON = exports.instanceOfAllocationDefinition = void 0;
/**
 * Check if a given object implements the AllocationDefinition interface.
 */
function instanceOfAllocationDefinition(value) {
    let isInstance = true;
    isInstance = isInstance && "id" in value;
    isInstance = isInstance && "type" in value;
    isInstance = isInstance && "aliasIds" in value;
    isInstance = isInstance && "allocation" in value;
...
exports.instanceOfAllocationDefinition = instanceOfAllocationDefinition;
function AllocationDefinitionFromJSON(json) {
    return AllocationDefinitionFromJSONTyped(json, false);
}
exports.AllocationDefinitionFromJSON = AllocationDefinitionFromJSON;
function AllocationDefinitionFromJSONTyped(json, ignoreDiscriminator) {
...
exports.AllocationDefinitionFromJSONTyped = AllocationDefinitionFromJSONTyped;
function AllocationDefinitionToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.AllocationDefinitionToJSON = AllocationDefinitionToJSON;
