...
exports.AnalysisCaseUsageRequestToJSON = exports.AnalysisCaseUsageRequestFromJSONTyped = exports.AnalysisCaseUsageRequestFromJSON = exports.instanceOfAnalysisCaseUsageRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the AnalysisCaseUsageRequest interface.
 */
function instanceOfAnalysisCaseUsageRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfAnalysisCaseUsageRequest = instanceOfAnalysisCaseUsageRequest;
function AnalysisCaseUsageRequestFromJSON(json) {
    return AnalysisCaseUsageRequestFromJSONTyped(json, false);
}
exports.AnalysisCaseUsageRequestFromJSON = AnalysisCaseUsageRequestFromJSON;
function AnalysisCaseUsageRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'analysisAction': !(0, runtime_1.exists)(json, 'analysisAction') ? undefined : json['analysisAction'],
        'analysisCaseDefinition': !(0, runtime_1.exists)(json, 'analysisCaseDefinition') ? undefined : json['analysisCaseDefinition'],
        ...
        'resultExpression': !(0, runtime_1.exists)(json, 'resultExpression') ? undefined : json['resultExpression'],
...
exports.AnalysisCaseUsageRequestFromJSONTyped = AnalysisCaseUsageRequestFromJSONTyped;
function AnalysisCaseUsageRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.AnalysisCaseUsageRequestToJSON = AnalysisCaseUsageRequestToJSON;
