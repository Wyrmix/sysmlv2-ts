...
exports.LiteralInfinityToJSON = exports.LiteralInfinityFromJSONTyped = exports.LiteralInfinityFromJSON = exports.instanceOfLiteralInfinity = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the LiteralInfinity interface.
 */
function instanceOfLiteralInfinity(value) {
    let isInstance = true;
...
exports.instanceOfLiteralInfinity = instanceOfLiteralInfinity;
function LiteralInfinityFromJSON(json) {
    return LiteralInfinityFromJSONTyped(json, false);
}
exports.LiteralInfinityFromJSON = LiteralInfinityFromJSON;
function LiteralInfinityFromJSONTyped(json, ignoreDiscriminator) {
...
exports.LiteralInfinityFromJSONTyped = LiteralInfinityFromJSONTyped;
function LiteralInfinityToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.LiteralInfinityToJSON = LiteralInfinityToJSON;
