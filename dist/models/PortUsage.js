...
exports.PortUsageToJSON = exports.PortUsageFromJSONTyped = exports.PortUsageFromJSON = exports.instanceOfPortUsage = void 0;
/**
 * Check if a given object implements the PortUsage interface.
 */
function instanceOfPortUsage(value) {
    let isInstance = true;
...
exports.instanceOfPortUsage = instanceOfPortUsage;
function PortUsageFromJSON(json) {
    return PortUsageFromJSONTyped(json, false);
}
exports.PortUsageFromJSON = PortUsageFromJSON;
function PortUsageFromJSONTyped(json, ignoreDiscriminator) {
...
exports.PortUsageFromJSONTyped = PortUsageFromJSONTyped;
function PortUsageToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.PortUsageToJSON = PortUsageToJSON;
