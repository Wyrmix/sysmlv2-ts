...
exports.LiteralIntegerToJSON = exports.LiteralIntegerFromJSONTyped = exports.LiteralIntegerFromJSON = exports.instanceOfLiteralInteger = void 0;
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the LiteralInteger interface.
 */
function instanceOfLiteralInteger(value) {
    let isInstance = true;
...
exports.instanceOfLiteralInteger = instanceOfLiteralInteger;
function LiteralIntegerFromJSON(json) {
    return LiteralIntegerFromJSONTyped(json, false);
}
exports.LiteralIntegerFromJSON = LiteralIntegerFromJSON;
function LiteralIntegerFromJSONTyped(json, ignoreDiscriminator) {
...
exports.LiteralIntegerFromJSONTyped = LiteralIntegerFromJSONTyped;
function LiteralIntegerToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.LiteralIntegerToJSON = LiteralIntegerToJSON;
