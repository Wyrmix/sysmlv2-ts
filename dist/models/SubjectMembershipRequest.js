...
exports.SubjectMembershipRequestToJSON = exports.SubjectMembershipRequestFromJSONTyped = exports.SubjectMembershipRequestFromJSON = exports.instanceOfSubjectMembershipRequest = void 0;
const runtime_1 = require("../runtime");
const Identified_1 = require("./Identified");
/**
 * Check if a given object implements the SubjectMembershipRequest interface.
 */
function instanceOfSubjectMembershipRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfSubjectMembershipRequest = instanceOfSubjectMembershipRequest;
function SubjectMembershipRequestFromJSON(json) {
    return SubjectMembershipRequestFromJSONTyped(json, false);
}
exports.SubjectMembershipRequestFromJSON = SubjectMembershipRequestFromJSON;
function SubjectMembershipRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'ownedSubjectParameter': !(0, runtime_1.exists)(json, 'ownedSubjectParameter') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['ownedSubjectParameter']),
...
exports.SubjectMembershipRequestFromJSONTyped = SubjectMembershipRequestFromJSONTyped;
function SubjectMembershipRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.SubjectMembershipRequestToJSON = SubjectMembershipRequestToJSON;
