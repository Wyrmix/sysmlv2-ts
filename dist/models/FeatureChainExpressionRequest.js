...
exports.FeatureChainExpressionRequestToJSON = exports.FeatureChainExpressionRequestFromJSONTyped = exports.FeatureChainExpressionRequestFromJSON = exports.instanceOfFeatureChainExpressionRequest = void 0;
 ...
 */
function instanceOfFeatureChainExpressionRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfFeatureChainExpressionRequest = instanceOfFeatureChainExpressionRequest;
function FeatureChainExpressionRequestFromJSON(json) {
    return FeatureChainExpressionRequestFromJSONTyped(json, false);
}
exports.FeatureChainExpressionRequestFromJSON = FeatureChainExpressionRequestFromJSON;
function FeatureChainExpressionRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'targetFeature': !(0, runtime_1.exists)(json, 'targetFeature') ? undefined : (0, Identified_1.IdentifiedFromJSON)(json['targetFeature']),
...
exports.FeatureChainExpressionRequestFromJSONTyped = FeatureChainExpressionRequestFromJSONTyped;
function FeatureChainExpressionRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'targetFeature': (0, Identified_1.IdentifiedToJSON)(value.targetFeature),
        'textualRepresentation': value.textualRepresentation,
        'type': value.type,
        'unioningType': value.unioningType,
    };
}
exports.FeatureChainExpressionRequestToJSON = FeatureChainExpressionRequestToJSON;
