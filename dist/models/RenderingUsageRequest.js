...
exports.RenderingUsageRequestToJSON = exports.RenderingUsageRequestFromJSONTyped = exports.RenderingUsageRequestFromJSON = exports.instanceOfRenderingUsageRequest = void 0;
const runtime_1 = require("../runtime");
/**
 * Check if a given object implements the RenderingUsageRequest interface.
 */
function instanceOfRenderingUsageRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfRenderingUsageRequest = instanceOfRenderingUsageRequest;
function RenderingUsageRequestFromJSON(json) {
    return RenderingUsageRequestFromJSONTyped(json, false);
}
exports.RenderingUsageRequestFromJSON = RenderingUsageRequestFromJSON;
function RenderingUsageRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'renderingDefinition': !(0, runtime_1.exists)(json, 'renderingDefinition') ? undefined : json['renderingDefinition'],
...
exports.RenderingUsageRequestFromJSONTyped = RenderingUsageRequestFromJSONTyped;
function RenderingUsageRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.RenderingUsageRequestToJSON = RenderingUsageRequestToJSON;
