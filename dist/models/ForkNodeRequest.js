...
exports.ForkNodeRequestToJSON = exports.ForkNodeRequestFromJSONTyped = exports.ForkNodeRequestFromJSON = exports.instanceOfForkNodeRequest = void 0;
const runtime_1 = require("../runtime");
/**
 * Check if a given object implements the ForkNodeRequest interface.
 */
function instanceOfForkNodeRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfForkNodeRequest = instanceOfForkNodeRequest;
function ForkNodeRequestFromJSON(json) {
    return ForkNodeRequestFromJSONTyped(json, false);
}
exports.ForkNodeRequestFromJSON = ForkNodeRequestFromJSON;
function ForkNodeRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.ForkNodeRequestFromJSONTyped = ForkNodeRequestFromJSONTyped;
function ForkNodeRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ForkNodeRequestToJSON = ForkNodeRequestToJSON;
