...
exports.ViewDefinitionRequestToJSON = exports.ViewDefinitionRequestFromJSONTyped = exports.ViewDefinitionRequestFromJSON = exports.instanceOfViewDefinitionRequest = void 0;
const runtime_1 = require("../runtime");
/**
 * Check if a given object implements the ViewDefinitionRequest interface.
 */
function instanceOfViewDefinitionRequest(value) {
    let isInstance = true;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfViewDefinitionRequest = instanceOfViewDefinitionRequest;
function ViewDefinitionRequestFromJSON(json) {
    return ViewDefinitionRequestFromJSONTyped(json, false);
}
exports.ViewDefinitionRequestFromJSON = ViewDefinitionRequestFromJSON;
function ViewDefinitionRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.ViewDefinitionRequestFromJSONTyped = ViewDefinitionRequestFromJSONTyped;
function ViewDefinitionRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ViewDefinitionRequestToJSON = ViewDefinitionRequestToJSON;
