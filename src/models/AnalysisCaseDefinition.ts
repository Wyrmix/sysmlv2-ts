 ...
 */
export function instanceOfAnalysisCaseDefinition(value: object): boolean {
    let isInstance = true;
...
export function AnalysisCaseDefinitionFromJSON(json: any): AnalysisCaseDefinition {
    return AnalysisCaseDefinitionFromJSONTyped(json, false);
}

export function AnalysisCaseDefinitionFromJSONTyped(json: any, ignoreDiscriminator: boolean): AnalysisCaseDefinition {
...
export function AnalysisCaseDefinitionToJSON(value?: AnalysisCaseDefinition | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
