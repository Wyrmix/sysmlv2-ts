 ...
 */
export function instanceOfDecisionNode(value: object): boolean {
    let isInstance = true;
...
export function DecisionNodeFromJSON(json: any): DecisionNode {
    return DecisionNodeFromJSONTyped(json, false);
}

export function DecisionNodeFromJSONTyped(json: any, ignoreDiscriminator: boolean): DecisionNode {
...
export function DecisionNodeToJSON(value?: DecisionNode | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
