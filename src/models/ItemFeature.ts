 ...
 */
export function instanceOfItemFeature(value: object): boolean {
    let isInstance = true;
...
export function ItemFeatureFromJSON(json: any): ItemFeature {
    return ItemFeatureFromJSONTyped(json, false);
}

export function ItemFeatureFromJSONTyped(json: any, ignoreDiscriminator: boolean): ItemFeature {
...
export function ItemFeatureToJSON(value?: ItemFeature | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
