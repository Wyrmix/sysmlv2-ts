 ...
 */
export function instanceOfAcceptActionUsage(value: object): boolean {
    let isInstance = true;
...
export function AcceptActionUsageFromJSON(json: any): AcceptActionUsage {
    return AcceptActionUsageFromJSONTyped(json, false);
}

export function AcceptActionUsageFromJSONTyped(json: any, ignoreDiscriminator: boolean): AcceptActionUsage {
    ...
    return {
        ...
        'payloadParameter': IdentifiedFromJSON(json['payloadParameter']),
...
export function AcceptActionUsageToJSON(value?: AcceptActionUsage | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
