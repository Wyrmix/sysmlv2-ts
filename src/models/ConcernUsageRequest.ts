 ...
 */
export function instanceOfConcernUsageRequest(value: object): boolean {
    let isInstance = true;
...
export function ConcernUsageRequestFromJSON(json: any): ConcernUsageRequest {
    return ConcernUsageRequestFromJSONTyped(json, false);
}

export function ConcernUsageRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConcernUsageRequest {
    ...
    return {
        ...
        'concernDefinition': !exists(json, 'concernDefinition') ? undefined : json['concernDefinition'],
...
export function ConcernUsageRequestToJSON(value?: ConcernUsageRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
