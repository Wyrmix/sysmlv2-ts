 ...
 */
export function instanceOfInterfaceDefinition(value: object): boolean {
    let isInstance = true;
...
export function InterfaceDefinitionFromJSON(json: any): InterfaceDefinition {
    return InterfaceDefinitionFromJSONTyped(json, false);
}

export function InterfaceDefinitionFromJSONTyped(json: any, ignoreDiscriminator: boolean): InterfaceDefinition {
...
export function InterfaceDefinitionToJSON(value?: InterfaceDefinition | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
