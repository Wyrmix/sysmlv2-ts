 ...
 */
export function instanceOfFlowConnectionDefinition(value: object): boolean {
    let isInstance = true;
...
export function FlowConnectionDefinitionFromJSON(json: any): FlowConnectionDefinition {
    return FlowConnectionDefinitionFromJSONTyped(json, false);
}

export function FlowConnectionDefinitionFromJSONTyped(json: any, ignoreDiscriminator: boolean): FlowConnectionDefinition {
...
export function FlowConnectionDefinitionToJSON(value?: FlowConnectionDefinition | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
