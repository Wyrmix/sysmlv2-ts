 ...
 */
export function instanceOfTransitionUsage(value: object): boolean {
    let isInstance = true;
...
export function TransitionUsageFromJSON(json: any): TransitionUsage {
    return TransitionUsageFromJSONTyped(json, false);
}

export function TransitionUsageFromJSONTyped(json: any, ignoreDiscriminator: boolean): TransitionUsage {
    ...
    return {
        ...
        'source': IdentifiedFromJSON(json['source']),
        'succession': IdentifiedFromJSON(json['succession']),
        'target': IdentifiedFromJSON(json['target']),
...
export function TransitionUsageToJSON(value?: TransitionUsage | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
