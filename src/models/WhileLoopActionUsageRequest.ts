 ...
 */
export function instanceOfWhileLoopActionUsageRequest(value: object): boolean {
    let isInstance = true;
...
export function WhileLoopActionUsageRequestFromJSON(json: any): WhileLoopActionUsageRequest {
    return WhileLoopActionUsageRequestFromJSONTyped(json, false);
}

export function WhileLoopActionUsageRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): WhileLoopActionUsageRequest {
    ...
    return {
        ...
        'untilArgument': !exists(json, 'untilArgument') ? undefined : json['untilArgument'],
        ...
        'whileArgument': !exists(json, 'whileArgument') ? undefined : IdentifiedFromJSON(json['whileArgument']),
    };
}

export function WhileLoopActionUsageRequestToJSON(value?: WhileLoopActionUsageRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
