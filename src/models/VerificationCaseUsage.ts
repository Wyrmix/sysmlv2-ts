 ...
 */
export function instanceOfVerificationCaseUsage(value: object): boolean {
    let isInstance = true;
...
export function VerificationCaseUsageFromJSON(json: any): VerificationCaseUsage {
    return VerificationCaseUsageFromJSONTyped(json, false);
}

export function VerificationCaseUsageFromJSONTyped(json: any, ignoreDiscriminator: boolean): VerificationCaseUsage {
...
export function VerificationCaseUsageToJSON(value?: VerificationCaseUsage | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
