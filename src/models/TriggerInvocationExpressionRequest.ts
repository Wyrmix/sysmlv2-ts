 ...
 */
export function instanceOfTriggerInvocationExpressionRequest(value: object): boolean {
    let isInstance = true;
...
export function TriggerInvocationExpressionRequestFromJSON(json: any): TriggerInvocationExpressionRequest {
    return TriggerInvocationExpressionRequestFromJSONTyped(json, false);
}

export function TriggerInvocationExpressionRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): TriggerInvocationExpressionRequest {
...
export function TriggerInvocationExpressionRequestToJSON(value?: TriggerInvocationExpressionRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
