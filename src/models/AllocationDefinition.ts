 ...
 */
export function instanceOfAllocationDefinition(value: object): boolean {
    let isInstance = true;
...
export function AllocationDefinitionFromJSON(json: any): AllocationDefinition {
    return AllocationDefinitionFromJSONTyped(json, false);
}

export function AllocationDefinitionFromJSONTyped(json: any, ignoreDiscriminator: boolean): AllocationDefinition {
...
export function AllocationDefinitionToJSON(value?: AllocationDefinition | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
