 ...
 */
export function instanceOfRenderingUsageRequest(value: object): boolean {
    let isInstance = true;
...
export function RenderingUsageRequestFromJSON(json: any): RenderingUsageRequest {
    return RenderingUsageRequestFromJSONTyped(json, false);
}

export function RenderingUsageRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): RenderingUsageRequest {
    ...
    return {
        ...
        'renderingDefinition': !exists(json, 'renderingDefinition') ? undefined : json['renderingDefinition'],
...
export function RenderingUsageRequestToJSON(value?: RenderingUsageRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
