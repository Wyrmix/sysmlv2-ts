 ...
 */
export function instanceOfLibraryPackage(value: object): boolean {
    let isInstance = true;
...
export function LibraryPackageFromJSON(json: any): LibraryPackage {
    return LibraryPackageFromJSONTyped(json, false);
}

export function LibraryPackageFromJSONTyped(json: any, ignoreDiscriminator: boolean): LibraryPackage {
...
export function LibraryPackageToJSON(value?: LibraryPackage | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
