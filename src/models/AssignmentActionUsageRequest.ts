 ...
 */
export function instanceOfAssignmentActionUsageRequest(value: object): boolean {
    let isInstance = true;
...
export function AssignmentActionUsageRequestFromJSON(json: any): AssignmentActionUsageRequest {
    return AssignmentActionUsageRequestFromJSONTyped(json, false);
}

export function AssignmentActionUsageRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): AssignmentActionUsageRequest {
    ...
    return {
        ...
        'targetArgument': !exists(json, 'targetArgument') ? undefined : IdentifiedFromJSON(json['targetArgument']),
        ...
        'valueExpression': !exists(json, 'valueExpression') ? undefined : IdentifiedFromJSON(json['valueExpression']),
...
export function AssignmentActionUsageRequestToJSON(value?: AssignmentActionUsageRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
