 ...
 */
export function instanceOfLiteralRational(value: object): boolean {
    let isInstance = true;
...
export function LiteralRationalFromJSON(json: any): LiteralRational {
    return LiteralRationalFromJSONTyped(json, false);
}

export function LiteralRationalFromJSONTyped(json: any, ignoreDiscriminator: boolean): LiteralRational {
...
export function LiteralRationalToJSON(value?: LiteralRational | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
