 ...
 */
export function instanceOfItemFlowEnd(value: object): boolean {
    let isInstance = true;
...
export function ItemFlowEndFromJSON(json: any): ItemFlowEnd {
    return ItemFlowEndFromJSONTyped(json, false);
}

export function ItemFlowEndFromJSONTyped(json: any, ignoreDiscriminator: boolean): ItemFlowEnd {
...
export function ItemFlowEndToJSON(value?: ItemFlowEnd | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
