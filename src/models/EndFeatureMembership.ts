 ...
 */
export function instanceOfEndFeatureMembership(value: object): boolean {
    let isInstance = true;
...
export function EndFeatureMembershipFromJSON(json: any): EndFeatureMembership {
    return EndFeatureMembershipFromJSONTyped(json, false);
}

export function EndFeatureMembershipFromJSONTyped(json: any, ignoreDiscriminator: boolean): EndFeatureMembership {
...
export function EndFeatureMembershipToJSON(value?: EndFeatureMembership | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
