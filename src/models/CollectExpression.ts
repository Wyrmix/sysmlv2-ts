 ...
 */
export function instanceOfCollectExpression(value: object): boolean {
    let isInstance = true;
...
export function CollectExpressionFromJSON(json: any): CollectExpression {
    return CollectExpressionFromJSONTyped(json, false);
}

export function CollectExpressionFromJSONTyped(json: any, ignoreDiscriminator: boolean): CollectExpression {
...
export function CollectExpressionToJSON(value?: CollectExpression | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
