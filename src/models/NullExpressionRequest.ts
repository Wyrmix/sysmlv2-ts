 ...
 */
export function instanceOfNullExpressionRequest(value: object): boolean {
    let isInstance = true;
...
export function NullExpressionRequestFromJSON(json: any): NullExpressionRequest {
    return NullExpressionRequestFromJSONTyped(json, false);
}

export function NullExpressionRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): NullExpressionRequest {
...
export function NullExpressionRequestToJSON(value?: NullExpressionRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
