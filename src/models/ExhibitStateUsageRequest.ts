 ...
 */
export function instanceOfExhibitStateUsageRequest(value: object): boolean {
    let isInstance = true;
...
export function ExhibitStateUsageRequestFromJSON(json: any): ExhibitStateUsageRequest {
    return ExhibitStateUsageRequestFromJSONTyped(json, false);
}

export function ExhibitStateUsageRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExhibitStateUsageRequest {
    ...
    return {
        ...
        'exhibitedState': !exists(json, 'exhibitedState') ? undefined : IdentifiedFromJSON(json['exhibitedState']),
        ...
        'stateDefinition': !exists(json, 'stateDefinition') ? undefined : json['stateDefinition'],
...
export function ExhibitStateUsageRequestToJSON(value?: ExhibitStateUsageRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
