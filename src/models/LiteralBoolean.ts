 ...
 */
export function instanceOfLiteralBoolean(value: object): boolean {
    let isInstance = true;
...
export function LiteralBooleanFromJSON(json: any): LiteralBoolean {
    return LiteralBooleanFromJSONTyped(json, false);
}

export function LiteralBooleanFromJSONTyped(json: any, ignoreDiscriminator: boolean): LiteralBoolean {
...
export function LiteralBooleanToJSON(value?: LiteralBoolean | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
